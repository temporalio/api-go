...
type PollNexusTaskQueueResponse struct {
	...
	// Caller identity attributed and verified by the handler server for this
	// Nexus request (e.g. from a signed caller-identity token on the inbound
	// request). Server-set and trusted: workers observe it but cannot influence
	// it. Unset when the server did not attribute a caller (identity propagation
	// disabled or not configured). Do not use for routing or as a security
	// boundary on its own.
	CallerInfo    *v119.NexusCallerInfo `protobuf:"bytes,6,opt,name=caller_info,json=callerInfo,proto3" json:"caller_info,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *PollNexusTaskQueueResponse) GetCallerInfo() *v119.NexusCallerInfo {
	if x != nil {
		return x.CallerInfo
	}
	return nil
...
const file_temporal_api_workflowservice_v1_request_response_proto_rawDesc = "" +
	...
	"\x10worker_heartbeat\x18\a \x03(\v2'.temporal.api.worker.v1.WorkerHeartbeatR\x0fworkerHeartbeat\"\xaa\x03\n" +
	...
	"\x12poller_group_infos\x18\x05 \x03(\v2*.temporal.api.taskqueue.v1.PollerGroupInfoR\x10pollerGroupInfos\x12G\n" +
	"\vcaller_info\x18\x06 \x01(\v2&.temporal.api.nexus.v1.NexusCallerInfoR\n" +
	"callerInfo\"\xe0\x01\n" +
...
var file_temporal_api_workflowservice_v1_request_response_proto_goTypes = []any{
	...
	(*v119.NexusCallerInfo)(nil),                                    // 380: temporal.api.nexus.v1.NexusCallerInfo
...
var file_temporal_api_workflowservice_v1_request_response_proto_depIdxs = []int32{
	...
	380, // 281: temporal.api.workflowservice.v1.PollNexusTaskQueueResponse.caller_info:type_name -> temporal.api.nexus.v1.NexusCallerInfo
