...
type StartNexusOperationExecutionRequest struct {
	...
	CompletionCallbacks []*v14.Callback `protobuf:"bytes,17,rep,name=completion_callbacks,json=completionCallbacks,proto3" json:"completion_callbacks,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
const file_temporal_api_workflowservice_v1_request_response_proto_rawDesc = "" +
	...
	"\x14completion_callbacks\x18\x11 \x03(\v2 .temporal.api.common.v1.CallbackR\x13completionCallbacks\x1a>\n" +
...
var file_temporal_api_workflowservice_v1_request_response_proto_depIdxs = []int32{
	...
	298, // 389: temporal.api.workflowservice.v1.StartNexusOperationExecutionRequest.completion_callbacks:type_name -> temporal.api.common.v1.Callback
