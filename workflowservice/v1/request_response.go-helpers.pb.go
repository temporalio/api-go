...
// Marshal an object of type DescribeActivityByIdRequest to the protobuf v3 wire format
func (val *DescribeActivityByIdRequest) Marshal() ([]byte, error) {
	return proto.Marshal(val)
}

// Unmarshal an object of type DescribeActivityByIdRequest from the protobuf v3 wire format
func (val *DescribeActivityByIdRequest) Unmarshal(buf []byte) error {
	return proto.Unmarshal(buf, val)
}

// Size returns the size of the object, in bytes, once serialized
func (val *DescribeActivityByIdRequest) Size() int {
	return proto.Size(val)
}

// Equal returns whether two DescribeActivityByIdRequest values are equivalent by recursively
// comparing the message's fields.
// For more information see the documentation for
// https://pkg.go.dev/google.golang.org/protobuf/proto#Equal
func (this *DescribeActivityByIdRequest) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	var that1 *DescribeActivityByIdRequest
	switch t := that.(type) {
	case *DescribeActivityByIdRequest:
		that1 = t
	case DescribeActivityByIdRequest:
		that1 = &t
	default:
...
// Marshal an object of type DescribeActivityByIdResponse to the protobuf v3 wire format
func (val *DescribeActivityByIdResponse) Marshal() ([]byte, error) {
	return proto.Marshal(val)
}

// Unmarshal an object of type DescribeActivityByIdResponse from the protobuf v3 wire format
func (val *DescribeActivityByIdResponse) Unmarshal(buf []byte) error {
	return proto.Unmarshal(buf, val)
}

// Size returns the size of the object, in bytes, once serialized
func (val *DescribeActivityByIdResponse) Size() int {
	return proto.Size(val)
}

// Equal returns whether two DescribeActivityByIdResponse values are equivalent by recursively
// comparing the message's fields.
// For more information see the documentation for
// https://pkg.go.dev/google.golang.org/protobuf/proto#Equal
func (this *DescribeActivityByIdResponse) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	var that1 *DescribeActivityByIdResponse
	switch t := that.(type) {
	case *DescribeActivityByIdResponse:
		that1 = t
	case DescribeActivityByIdResponse:
		that1 = &t
	default:
