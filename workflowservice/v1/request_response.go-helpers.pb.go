...
// Marshal an object of type WaitForExternalWorkflowRequest to the protobuf v3 wire format
func (val *WaitForExternalWorkflowRequest) Marshal() ([]byte, error) {
	return proto.Marshal(val)
}

// Unmarshal an object of type WaitForExternalWorkflowRequest from the protobuf v3 wire format
func (val *WaitForExternalWorkflowRequest) Unmarshal(buf []byte) error {
	return proto.Unmarshal(buf, val)
}

// Size returns the size of the object, in bytes, once serialized
func (val *WaitForExternalWorkflowRequest) Size() int {
	return proto.Size(val)
}

// Equal returns whether two WaitForExternalWorkflowRequest values are equivalent by recursively
// comparing the message's fields.
// For more information see the documentation for
// https://pkg.go.dev/google.golang.org/protobuf/proto#Equal
func (this *WaitForExternalWorkflowRequest) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	var that1 *WaitForExternalWorkflowRequest
	switch t := that.(type) {
	case *WaitForExternalWorkflowRequest:
		that1 = t
	case WaitForExternalWorkflowRequest:
		that1 = &t
	default:
...
// Marshal an object of type WaitForExternalWorkflowResponse to the protobuf v3 wire format
func (val *WaitForExternalWorkflowResponse) Marshal() ([]byte, error) {
	return proto.Marshal(val)
}

// Unmarshal an object of type WaitForExternalWorkflowResponse from the protobuf v3 wire format
func (val *WaitForExternalWorkflowResponse) Unmarshal(buf []byte) error {
	return proto.Unmarshal(buf, val)
}

// Size returns the size of the object, in bytes, once serialized
func (val *WaitForExternalWorkflowResponse) Size() int {
	return proto.Size(val)
}

// Equal returns whether two WaitForExternalWorkflowResponse values are equivalent by recursively
// comparing the message's fields.
// For more information see the documentation for
// https://pkg.go.dev/google.golang.org/protobuf/proto#Equal
func (this *WaitForExternalWorkflowResponse) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	var that1 *WaitForExternalWorkflowResponse
	switch t := that.(type) {
	case *WaitForExternalWorkflowResponse:
		that1 = t
	case WaitForExternalWorkflowResponse:
		that1 = &t
	default:
