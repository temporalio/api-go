...
const file_temporal_api_workflowservice_v1_service_proto_rawDesc = "" +
	"\n" +
	"-temporal/api/workflowservice/v1/service.proto\x12\x1ftemporal.api.workflowservice.v1\x1a6temporal/api/workflowservice/v1/request_response.proto\x1a\x1cgoogle/api/annotations.proto\x1a+temporal/api/protometa/v1/annotations.proto2\xac\xfa\x01\n" +
...
var file_temporal_api_workflowservice_v1_service_proto_goTypes = []any{
	...
	(*UpdateWorkerDeploymentVersionMetadataRequest)(nil),  // 69: temporal.api.workflowservice.v1.UpdateWorkerDeploymentVersionMetadataRequest
	(*SetWorkerDeploymentManagerRequest)(nil),             // 70: temporal.api.workflowservice.v1.SetWorkerDeploymentManagerRequest
	(*UpdateWorkflowExecutionRequest)(nil),                // 71: temporal.api.workflowservice.v1.UpdateWorkflowExecutionRequest
	(*PollWorkflowExecutionUpdateRequest)(nil),            // 72: temporal.api.workflowservice.v1.PollWorkflowExecutionUpdateRequest
	(*StartBatchOperationRequest)(nil),                    // 73: temporal.api.workflowservice.v1.StartBatchOperationRequest
	(*StopBatchOperationRequest)(nil),                     // 74: temporal.api.workflowservice.v1.StopBatchOperationRequest
	(*DescribeBatchOperationRequest)(nil),                 // 75: temporal.api.workflowservice.v1.DescribeBatchOperationRequest
	(*ListBatchOperationsRequest)(nil),                    // 76: temporal.api.workflowservice.v1.ListBatchOperationsRequest
	(*PollNexusTaskQueueRequest)(nil),                     // 77: temporal.api.workflowservice.v1.PollNexusTaskQueueRequest
	(*RespondNexusTaskCompletedRequest)(nil),              // 78: temporal.api.workflowservice.v1.RespondNexusTaskCompletedRequest
	(*RespondNexusTaskFailedRequest)(nil),                 // 79: temporal.api.workflowservice.v1.RespondNexusTaskFailedRequest
	(*UpdateActivityOptionsRequest)(nil),                  // 80: temporal.api.workflowservice.v1.UpdateActivityOptionsRequest
	(*UpdateWorkflowExecutionOptionsRequest)(nil),         // 81: temporal.api.workflowservice.v1.UpdateWorkflowExecutionOptionsRequest
	(*PauseActivityRequest)(nil),                          // 82: temporal.api.workflowservice.v1.PauseActivityRequest
	(*UnpauseActivityRequest)(nil),                        // 83: temporal.api.workflowservice.v1.UnpauseActivityRequest
	(*ResetActivityRequest)(nil),                          // 84: temporal.api.workflowservice.v1.ResetActivityRequest
	(*CreateWorkflowRuleRequest)(nil),                     // 85: temporal.api.workflowservice.v1.CreateWorkflowRuleRequest
	(*DescribeWorkflowRuleRequest)(nil),                   // 86: temporal.api.workflowservice.v1.DescribeWorkflowRuleRequest
	(*DeleteWorkflowRuleRequest)(nil),                     // 87: temporal.api.workflowservice.v1.DeleteWorkflowRuleRequest
	(*ListWorkflowRulesRequest)(nil),                      // 88: temporal.api.workflowservice.v1.ListWorkflowRulesRequest
	(*TriggerWorkflowRuleRequest)(nil),                    // 89: temporal.api.workflowservice.v1.TriggerWorkflowRuleRequest
	(*RecordWorkerHeartbeatRequest)(nil),                  // 90: temporal.api.workflowservice.v1.RecordWorkerHeartbeatRequest
	(*ListWorkersRequest)(nil),                            // 91: temporal.api.workflowservice.v1.ListWorkersRequest
	(*UpdateTaskQueueConfigRequest)(nil),                  // 92: temporal.api.workflowservice.v1.UpdateTaskQueueConfigRequest
	(*FetchWorkerConfigRequest)(nil),                      // 93: temporal.api.workflowservice.v1.FetchWorkerConfigRequest
	(*UpdateWorkerConfigRequest)(nil),                     // 94: temporal.api.workflowservice.v1.UpdateWorkerConfigRequest
	(*DescribeWorkerRequest)(nil),                         // 95: temporal.api.workflowservice.v1.DescribeWorkerRequest
	(*PauseWorkflowExecutionRequest)(nil),                 // 96: temporal.api.workflowservice.v1.PauseWorkflowExecutionRequest
	(*UnpauseWorkflowExecutionRequest)(nil),               // 97: temporal.api.workflowservice.v1.UnpauseWorkflowExecutionRequest
	...
	(*PollActivityExecutionRequest)(nil),                  // 100: temporal.api.workflowservice.v1.PollActivityExecutionRequest
	(*ListActivityExecutionsRequest)(nil),                 // 101: temporal.api.workflowservice.v1.ListActivityExecutionsRequest
	(*CountActivityExecutionsRequest)(nil),                // 102: temporal.api.workflowservice.v1.CountActivityExecutionsRequest
	...
	(*CountSchedulesResponse)(nil),                        // 156: temporal.api.workflowservice.v1.CountSchedulesResponse
	...
	(*CreateWorkerDeploymentResponse)(nil),                // 174: temporal.api.workflowservice.v1.CreateWorkerDeploymentResponse
	(*UpdateWorkerDeploymentVersionMetadataResponse)(nil), // 175: temporal.api.workflowservice.v1.UpdateWorkerDeploymentVersionMetadataResponse
	(*SetWorkerDeploymentManagerResponse)(nil),            // 176: temporal.api.workflowservice.v1.SetWorkerDeploymentManagerResponse
	(*UpdateWorkflowExecutionResponse)(nil),               // 177: temporal.api.workflowservice.v1.UpdateWorkflowExecutionResponse
	(*PollWorkflowExecutionUpdateResponse)(nil),           // 178: temporal.api.workflowservice.v1.PollWorkflowExecutionUpdateResponse
	(*StartBatchOperationResponse)(nil),                   // 179: temporal.api.workflowservice.v1.StartBatchOperationResponse
	(*StopBatchOperationResponse)(nil),                    // 180: temporal.api.workflowservice.v1.StopBatchOperationResponse
	(*DescribeBatchOperationResponse)(nil),                // 181: temporal.api.workflowservice.v1.DescribeBatchOperationResponse
	(*ListBatchOperationsResponse)(nil),                   // 182: temporal.api.workflowservice.v1.ListBatchOperationsResponse
	(*PollNexusTaskQueueResponse)(nil),                    // 183: temporal.api.workflowservice.v1.PollNexusTaskQueueResponse
	(*RespondNexusTaskCompletedResponse)(nil),             // 184: temporal.api.workflowservice.v1.RespondNexusTaskCompletedResponse
	(*RespondNexusTaskFailedResponse)(nil),                // 185: temporal.api.workflowservice.v1.RespondNexusTaskFailedResponse
	...
	(*ResetActivityResponse)(nil),                         // 190: temporal.api.workflowservice.v1.ResetActivityResponse
	(*CreateWorkflowRuleResponse)(nil),                    // 191: temporal.api.workflowservice.v1.CreateWorkflowRuleResponse
	(*DescribeWorkflowRuleResponse)(nil),                  // 192: temporal.api.workflowservice.v1.DescribeWorkflowRuleResponse
	(*DeleteWorkflowRuleResponse)(nil),                    // 193: temporal.api.workflowservice.v1.DeleteWorkflowRuleResponse
	(*ListWorkflowRulesResponse)(nil),                     // 194: temporal.api.workflowservice.v1.ListWorkflowRulesResponse
	...
	(*UpdateTaskQueueConfigResponse)(nil),                 // 198: temporal.api.workflowservice.v1.UpdateTaskQueueConfigResponse
	(*FetchWorkerConfigResponse)(nil),                     // 199: temporal.api.workflowservice.v1.FetchWorkerConfigResponse
	(*UpdateWorkerConfigResponse)(nil),                    // 200: temporal.api.workflowservice.v1.UpdateWorkerConfigResponse
	(*DescribeWorkerResponse)(nil),                        // 201: temporal.api.workflowservice.v1.DescribeWorkerResponse
	(*PauseWorkflowExecutionResponse)(nil),                // 202: temporal.api.workflowservice.v1.PauseWorkflowExecutionResponse
	(*UnpauseWorkflowExecutionResponse)(nil),              // 203: temporal.api.workflowservice.v1.UnpauseWorkflowExecutionResponse
	...
	(*PollActivityExecutionResponse)(nil),                 // 206: temporal.api.workflowservice.v1.PollActivityExecutionResponse
	(*ListActivityExecutionsResponse)(nil),                // 207: temporal.api.workflowservice.v1.ListActivityExecutionsResponse
	(*CountActivityExecutionsResponse)(nil),               // 208: temporal.api.workflowservice.v1.CountActivityExecutionsResponse
...
var file_temporal_api_workflowservice_v1_service_proto_depIdxs = []int32{
	...
	69,  // 69: temporal.api.workflowservice.v1.WorkflowService.UpdateWorkerDeploymentVersionMetadata:input_type -> temporal.api.workflowservice.v1.UpdateWorkerDeploymentVersionMetadataRequest
	70,  // 70: temporal.api.workflowservice.v1.WorkflowService.SetWorkerDeploymentManager:input_type -> temporal.api.workflowservice.v1.SetWorkerDeploymentManagerRequest
	71,  // 71: temporal.api.workflowservice.v1.WorkflowService.UpdateWorkflowExecution:input_type -> temporal.api.workflowservice.v1.UpdateWorkflowExecutionRequest
	72,  // 72: temporal.api.workflowservice.v1.WorkflowService.PollWorkflowExecutionUpdate:input_type -> temporal.api.workflowservice.v1.PollWorkflowExecutionUpdateRequest
	73,  // 73: temporal.api.workflowservice.v1.WorkflowService.StartBatchOperation:input_type -> temporal.api.workflowservice.v1.StartBatchOperationRequest
	74,  // 74: temporal.api.workflowservice.v1.WorkflowService.StopBatchOperation:input_type -> temporal.api.workflowservice.v1.StopBatchOperationRequest
	75,  // 75: temporal.api.workflowservice.v1.WorkflowService.DescribeBatchOperation:input_type -> temporal.api.workflowservice.v1.DescribeBatchOperationRequest
	76,  // 76: temporal.api.workflowservice.v1.WorkflowService.ListBatchOperations:input_type -> temporal.api.workflowservice.v1.ListBatchOperationsRequest
	77,  // 77: temporal.api.workflowservice.v1.WorkflowService.PollNexusTaskQueue:input_type -> temporal.api.workflowservice.v1.PollNexusTaskQueueRequest
	78,  // 78: temporal.api.workflowservice.v1.WorkflowService.RespondNexusTaskCompleted:input_type -> temporal.api.workflowservice.v1.RespondNexusTaskCompletedRequest
	79,  // 79: temporal.api.workflowservice.v1.WorkflowService.RespondNexusTaskFailed:input_type -> temporal.api.workflowservice.v1.RespondNexusTaskFailedRequest
	80,  // 80: temporal.api.workflowservice.v1.WorkflowService.UpdateActivityOptions:input_type -> temporal.api.workflowservice.v1.UpdateActivityOptionsRequest
	81,  // 81: temporal.api.workflowservice.v1.WorkflowService.UpdateWorkflowExecutionOptions:input_type -> temporal.api.workflowservice.v1.UpdateWorkflowExecutionOptionsRequest
	...
	83,  // 83: temporal.api.workflowservice.v1.WorkflowService.UnpauseActivity:input_type -> temporal.api.workflowservice.v1.UnpauseActivityRequest
	84,  // 84: temporal.api.workflowservice.v1.WorkflowService.ResetActivity:input_type -> temporal.api.workflowservice.v1.ResetActivityRequest
	85,  // 85: temporal.api.workflowservice.v1.WorkflowService.CreateWorkflowRule:input_type -> temporal.api.workflowservice.v1.CreateWorkflowRuleRequest
	86,  // 86: temporal.api.workflowservice.v1.WorkflowService.DescribeWorkflowRule:input_type -> temporal.api.workflowservice.v1.DescribeWorkflowRuleRequest
	87,  // 87: temporal.api.workflowservice.v1.WorkflowService.DeleteWorkflowRule:input_type -> temporal.api.workflowservice.v1.DeleteWorkflowRuleRequest
	88,  // 88: temporal.api.workflowservice.v1.WorkflowService.ListWorkflowRules:input_type -> temporal.api.workflowservice.v1.ListWorkflowRulesRequest
	89,  // 89: temporal.api.workflowservice.v1.WorkflowService.TriggerWorkflowRule:input_type -> temporal.api.workflowservice.v1.TriggerWorkflowRuleRequest
	90,  // 90: temporal.api.workflowservice.v1.WorkflowService.RecordWorkerHeartbeat:input_type -> temporal.api.workflowservice.v1.RecordWorkerHeartbeatRequest
	91,  // 91: temporal.api.workflowservice.v1.WorkflowService.ListWorkers:input_type -> temporal.api.workflowservice.v1.ListWorkersRequest
	92,  // 92: temporal.api.workflowservice.v1.WorkflowService.UpdateTaskQueueConfig:input_type -> temporal.api.workflowservice.v1.UpdateTaskQueueConfigRequest
	93,  // 93: temporal.api.workflowservice.v1.WorkflowService.FetchWorkerConfig:input_type -> temporal.api.workflowservice.v1.FetchWorkerConfigRequest
	94,  // 94: temporal.api.workflowservice.v1.WorkflowService.UpdateWorkerConfig:input_type -> temporal.api.workflowservice.v1.UpdateWorkerConfigRequest
	95,  // 95: temporal.api.workflowservice.v1.WorkflowService.DescribeWorker:input_type -> temporal.api.workflowservice.v1.DescribeWorkerRequest
	96,  // 96: temporal.api.workflowservice.v1.WorkflowService.PauseWorkflowExecution:input_type -> temporal.api.workflowservice.v1.PauseWorkflowExecutionRequest
	97,  // 97: temporal.api.workflowservice.v1.WorkflowService.UnpauseWorkflowExecution:input_type -> temporal.api.workflowservice.v1.UnpauseWorkflowExecutionRequest
	...
	100, // 100: temporal.api.workflowservice.v1.WorkflowService.PollActivityExecution:input_type -> temporal.api.workflowservice.v1.PollActivityExecutionRequest
	101, // 101: temporal.api.workflowservice.v1.WorkflowService.ListActivityExecutions:input_type -> temporal.api.workflowservice.v1.ListActivityExecutionsRequest
	102, // 102: temporal.api.workflowservice.v1.WorkflowService.CountActivityExecutions:input_type -> temporal.api.workflowservice.v1.CountActivityExecutionsRequest
	...
	156, // 156: temporal.api.workflowservice.v1.WorkflowService.CountSchedules:output_type -> temporal.api.workflowservice.v1.CountSchedulesResponse
	...
	174, // 174: temporal.api.workflowservice.v1.WorkflowService.CreateWorkerDeployment:output_type -> temporal.api.workflowservice.v1.CreateWorkerDeploymentResponse
	175, // 175: temporal.api.workflowservice.v1.WorkflowService.UpdateWorkerDeploymentVersionMetadata:output_type -> temporal.api.workflowservice.v1.UpdateWorkerDeploymentVersionMetadataResponse
	176, // 176: temporal.api.workflowservice.v1.WorkflowService.SetWorkerDeploymentManager:output_type -> temporal.api.workflowservice.v1.SetWorkerDeploymentManagerResponse
	177, // 177: temporal.api.workflowservice.v1.WorkflowService.UpdateWorkflowExecution:output_type -> temporal.api.workflowservice.v1.UpdateWorkflowExecutionResponse
	178, // 178: temporal.api.workflowservice.v1.WorkflowService.PollWorkflowExecutionUpdate:output_type -> temporal.api.workflowservice.v1.PollWorkflowExecutionUpdateResponse
	179, // 179: temporal.api.workflowservice.v1.WorkflowService.StartBatchOperation:output_type -> temporal.api.workflowservice.v1.StartBatchOperationResponse
	180, // 180: temporal.api.workflowservice.v1.WorkflowService.StopBatchOperation:output_type -> temporal.api.workflowservice.v1.StopBatchOperationResponse
	181, // 181: temporal.api.workflowservice.v1.WorkflowService.DescribeBatchOperation:output_type -> temporal.api.workflowservice.v1.DescribeBatchOperationResponse
	182, // 182: temporal.api.workflowservice.v1.WorkflowService.ListBatchOperations:output_type -> temporal.api.workflowservice.v1.ListBatchOperationsResponse
	183, // 183: temporal.api.workflowservice.v1.WorkflowService.PollNexusTaskQueue:output_type -> temporal.api.workflowservice.v1.PollNexusTaskQueueResponse
	184, // 184: temporal.api.workflowservice.v1.WorkflowService.RespondNexusTaskCompleted:output_type -> temporal.api.workflowservice.v1.RespondNexusTaskCompletedResponse
	185, // 185: temporal.api.workflowservice.v1.WorkflowService.RespondNexusTaskFailed:output_type -> temporal.api.workflowservice.v1.RespondNexusTaskFailedResponse
	...
	190, // 190: temporal.api.workflowservice.v1.WorkflowService.ResetActivity:output_type -> temporal.api.workflowservice.v1.ResetActivityResponse
	191, // 191: temporal.api.workflowservice.v1.WorkflowService.CreateWorkflowRule:output_type -> temporal.api.workflowservice.v1.CreateWorkflowRuleResponse
	192, // 192: temporal.api.workflowservice.v1.WorkflowService.DescribeWorkflowRule:output_type -> temporal.api.workflowservice.v1.DescribeWorkflowRuleResponse
	193, // 193: temporal.api.workflowservice.v1.WorkflowService.DeleteWorkflowRule:output_type -> temporal.api.workflowservice.v1.DeleteWorkflowRuleResponse
	194, // 194: temporal.api.workflowservice.v1.WorkflowService.ListWorkflowRules:output_type -> temporal.api.workflowservice.v1.ListWorkflowRulesResponse
	195, // 195: temporal.api.workflowservice.v1.WorkflowService.TriggerWorkflowRule:output_type -> temporal.api.workflowservice.v1.TriggerWorkflowRuleResponse
	196, // 196: temporal.api.workflowservice.v1.WorkflowService.RecordWorkerHeartbeat:output_type -> temporal.api.workflowservice.v1.RecordWorkerHeartbeatResponse
	197, // 197: temporal.api.workflowservice.v1.WorkflowService.ListWorkers:output_type -> temporal.api.workflowservice.v1.ListWorkersResponse
	198, // 198: temporal.api.workflowservice.v1.WorkflowService.UpdateTaskQueueConfig:output_type -> temporal.api.workflowservice.v1.UpdateTaskQueueConfigResponse
	199, // 199: temporal.api.workflowservice.v1.WorkflowService.FetchWorkerConfig:output_type -> temporal.api.workflowservice.v1.FetchWorkerConfigResponse
	200, // 200: temporal.api.workflowservice.v1.WorkflowService.UpdateWorkerConfig:output_type -> temporal.api.workflowservice.v1.UpdateWorkerConfigResponse
	201, // 201: temporal.api.workflowservice.v1.WorkflowService.DescribeWorker:output_type -> temporal.api.workflowservice.v1.DescribeWorkerResponse
	202, // 202: temporal.api.workflowservice.v1.WorkflowService.PauseWorkflowExecution:output_type -> temporal.api.workflowservice.v1.PauseWorkflowExecutionResponse
	203, // 203: temporal.api.workflowservice.v1.WorkflowService.UnpauseWorkflowExecution:output_type -> temporal.api.workflowservice.v1.UnpauseWorkflowExecutionResponse
	...
	206, // 206: temporal.api.workflowservice.v1.WorkflowService.PollActivityExecution:output_type -> temporal.api.workflowservice.v1.PollActivityExecutionResponse
	207, // 207: temporal.api.workflowservice.v1.WorkflowService.ListActivityExecutions:output_type -> temporal.api.workflowservice.v1.ListActivityExecutionsResponse
	208, // 208: temporal.api.workflowservice.v1.WorkflowService.CountActivityExecutions:output_type -> temporal.api.workflowservice.v1.CountActivityExecutionsResponse
