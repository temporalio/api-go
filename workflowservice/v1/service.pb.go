...
const file_temporal_api_workflowservice_v1_service_proto_rawDesc = "" +
	"\n" +
	"-temporal/api/workflowservice/v1/service.proto\x12\x1ftemporal.api.workflowservice.v1\x1a6temporal/api/workflowservice/v1/request_response.proto\x1a\x1cgoogle/api/annotations.proto\x1a+temporal/api/protometa/v1/annotations.proto2\xb4\x95\x02\n" +
	...
	"\x17DeleteActivityExecution\x12?.temporal.api.workflowservice.v1.DeleteActivityExecutionRequest\x1a@.temporal.api.workflowservice.v1.DeleteActivityExecutionResponse\"\x00\x12\x92\x02\n" +
	"\x16StartCallbackExecution\x12>.temporal.api.workflowservice.v1.StartCallbackExecutionRequest\x1a?.temporal.api.workflowservice.v1.StartCallbackExecutionResponse\"w\x82\xd3\xe4\x93\x02q:\x01*Z;:\x01*\"6/api/v1/namespaces/{namespace}/callbacks/{callback_id}\"//namespaces/{namespace}/callbacks/{callback_id}\x12\x95\x02\n" +
	"\x19DescribeCallbackExecution\x12A.temporal.api.workflowservice.v1.DescribeCallbackExecutionRequest\x1aB.temporal.api.workflowservice.v1.DescribeCallbackExecutionResponse\"q\x82\xd3\xe4\x93\x02kZ8\x126/api/v1/namespaces/{namespace}/callbacks/{callback_id}\x12//namespaces/{namespace}/callbacks/{callback_id}\x12\x9a\x02\n" +
	"\x15PollCallbackExecution\x12=.temporal.api.workflowservice.v1.PollCallbackExecutionRequest\x1a>.temporal.api.workflowservice.v1.PollCallbackExecutionResponse\"\x81\x01\x82\xd3\xe4\x93\x02{Z@\x12>/api/v1/namespaces/{namespace}/callbacks/{callback_id}/outcome\x127/namespaces/{namespace}/callbacks/{callback_id}/outcome\x12\xf0\x01\n" +
	"\x16ListCallbackExecutions\x12>.temporal.api.workflowservice.v1.ListCallbackExecutionsRequest\x1a?.temporal.api.workflowservice.v1.ListCallbackExecutionsResponse\"U\x82\xd3\xe4\x93\x02OZ*\x12(/api/v1/namespaces/{namespace}/callbacks\x12!/namespaces/{namespace}/callbacks\x12\xfd\x01\n" +
	"\x17CountCallbackExecutions\x12?.temporal.api.workflowservice.v1.CountCallbackExecutionsRequest\x1a@.temporal.api.workflowservice.v1.CountCallbackExecutionsResponse\"_\x82\xd3\xe4\x93\x02YZ/\x12-/api/v1/namespaces/{namespace}/callback-count\x12&/namespaces/{namespace}/callback-count\x12\xb4\x02\n" +
	"\x1aTerminateCallbackExecution\x12B.temporal.api.workflowservice.v1.TerminateCallbackExecutionRequest\x1aC.temporal.api.workflowservice.v1.TerminateCallbackExecutionResponse\"\x8c\x01\x82\xd3\xe4\x93\x02\x85\x01:\x01*ZE:\x01*\"@/api/v1/namespaces/{namespace}/callbacks/{callback_id}/terminate\"9/namespaces/{namespace}/callbacks/{callback_id}/terminate\x12\x9e\x01\n" +
	"\x17DeleteCallbackExecution\x12?.temporal.api.workflowservice.v1.DeleteCallbackExecutionRequest\x1a@.temporal.api.workflowservice.v1.DeleteCallbackExecutionResponse\"\x00B\xb6\x01\n" +
...
var file_temporal_api_workflowservice_v1_service_proto_goTypes = []any{
	...
	(*StartCallbackExecutionRequest)(nil),                        // 109: temporal.api.workflowservice.v1.StartCallbackExecutionRequest
	(*DescribeCallbackExecutionRequest)(nil),                     // 110: temporal.api.workflowservice.v1.DescribeCallbackExecutionRequest
	(*PollCallbackExecutionRequest)(nil),                         // 111: temporal.api.workflowservice.v1.PollCallbackExecutionRequest
	(*ListCallbackExecutionsRequest)(nil),                        // 112: temporal.api.workflowservice.v1.ListCallbackExecutionsRequest
	(*CountCallbackExecutionsRequest)(nil),                       // 113: temporal.api.workflowservice.v1.CountCallbackExecutionsRequest
	(*TerminateCallbackExecutionRequest)(nil),                    // 114: temporal.api.workflowservice.v1.TerminateCallbackExecutionRequest
	(*DeleteCallbackExecutionRequest)(nil),                       // 115: temporal.api.workflowservice.v1.DeleteCallbackExecutionRequest
	(*RegisterNamespaceResponse)(nil),                            // 116: temporal.api.workflowservice.v1.RegisterNamespaceResponse
	(*DescribeNamespaceResponse)(nil),                            // 117: temporal.api.workflowservice.v1.DescribeNamespaceResponse
	(*ListNamespacesResponse)(nil),                               // 118: temporal.api.workflowservice.v1.ListNamespacesResponse
	(*UpdateNamespaceResponse)(nil),                              // 119: temporal.api.workflowservice.v1.UpdateNamespaceResponse
	(*DeprecateNamespaceResponse)(nil),                           // 120: temporal.api.workflowservice.v1.DeprecateNamespaceResponse
	(*StartWorkflowExecutionResponse)(nil),                       // 121: temporal.api.workflowservice.v1.StartWorkflowExecutionResponse
	(*ExecuteMultiOperationResponse)(nil),                        // 122: temporal.api.workflowservice.v1.ExecuteMultiOperationResponse
	(*GetWorkflowExecutionHistoryResponse)(nil),                  // 123: temporal.api.workflowservice.v1.GetWorkflowExecutionHistoryResponse
	(*GetWorkflowExecutionHistoryReverseResponse)(nil),           // 124: temporal.api.workflowservice.v1.GetWorkflowExecutionHistoryReverseResponse
	(*PollWorkflowTaskQueueResponse)(nil),                        // 125: temporal.api.workflowservice.v1.PollWorkflowTaskQueueResponse
	(*RespondWorkflowTaskCompletedResponse)(nil),                 // 126: temporal.api.workflowservice.v1.RespondWorkflowTaskCompletedResponse
	(*RespondWorkflowTaskFailedResponse)(nil),                    // 127: temporal.api.workflowservice.v1.RespondWorkflowTaskFailedResponse
	(*PollActivityTaskQueueResponse)(nil),                        // 128: temporal.api.workflowservice.v1.PollActivityTaskQueueResponse
	(*RecordActivityTaskHeartbeatResponse)(nil),                  // 129: temporal.api.workflowservice.v1.RecordActivityTaskHeartbeatResponse
	(*RecordActivityTaskHeartbeatByIdResponse)(nil),              // 130: temporal.api.workflowservice.v1.RecordActivityTaskHeartbeatByIdResponse
	(*RespondActivityTaskCompletedResponse)(nil),                 // 131: temporal.api.workflowservice.v1.RespondActivityTaskCompletedResponse
	(*RespondActivityTaskCompletedByIdResponse)(nil),             // 132: temporal.api.workflowservice.v1.RespondActivityTaskCompletedByIdResponse
	(*RespondActivityTaskFailedResponse)(nil),                    // 133: temporal.api.workflowservice.v1.RespondActivityTaskFailedResponse
	(*RespondActivityTaskFailedByIdResponse)(nil),                // 134: temporal.api.workflowservice.v1.RespondActivityTaskFailedByIdResponse
	(*RespondActivityTaskCanceledResponse)(nil),                  // 135: temporal.api.workflowservice.v1.RespondActivityTaskCanceledResponse
	(*RespondActivityTaskCanceledByIdResponse)(nil),              // 136: temporal.api.workflowservice.v1.RespondActivityTaskCanceledByIdResponse
	(*RequestCancelWorkflowExecutionResponse)(nil),               // 137: temporal.api.workflowservice.v1.RequestCancelWorkflowExecutionResponse
	(*SignalWorkflowExecutionResponse)(nil),                      // 138: temporal.api.workflowservice.v1.SignalWorkflowExecutionResponse
	(*SignalWithStartWorkflowExecutionResponse)(nil),             // 139: temporal.api.workflowservice.v1.SignalWithStartWorkflowExecutionResponse
	(*ResetWorkflowExecutionResponse)(nil),                       // 140: temporal.api.workflowservice.v1.ResetWorkflowExecutionResponse
	(*TerminateWorkflowExecutionResponse)(nil),                   // 141: temporal.api.workflowservice.v1.TerminateWorkflowExecutionResponse
	(*DeleteWorkflowExecutionResponse)(nil),                      // 142: temporal.api.workflowservice.v1.DeleteWorkflowExecutionResponse
	(*ListOpenWorkflowExecutionsResponse)(nil),                   // 143: temporal.api.workflowservice.v1.ListOpenWorkflowExecutionsResponse
	(*ListClosedWorkflowExecutionsResponse)(nil),                 // 144: temporal.api.workflowservice.v1.ListClosedWorkflowExecutionsResponse
	(*ListWorkflowExecutionsResponse)(nil),                       // 145: temporal.api.workflowservice.v1.ListWorkflowExecutionsResponse
	(*ListArchivedWorkflowExecutionsResponse)(nil),               // 146: temporal.api.workflowservice.v1.ListArchivedWorkflowExecutionsResponse
	(*ScanWorkflowExecutionsResponse)(nil),                       // 147: temporal.api.workflowservice.v1.ScanWorkflowExecutionsResponse
	(*CountWorkflowExecutionsResponse)(nil),                      // 148: temporal.api.workflowservice.v1.CountWorkflowExecutionsResponse
	(*GetSearchAttributesResponse)(nil),                          // 149: temporal.api.workflowservice.v1.GetSearchAttributesResponse
	(*RespondQueryTaskCompletedResponse)(nil),                    // 150: temporal.api.workflowservice.v1.RespondQueryTaskCompletedResponse
	(*ResetStickyTaskQueueResponse)(nil),                         // 151: temporal.api.workflowservice.v1.ResetStickyTaskQueueResponse
	(*ShutdownWorkerResponse)(nil),                               // 152: temporal.api.workflowservice.v1.ShutdownWorkerResponse
	(*QueryWorkflowResponse)(nil),                                // 153: temporal.api.workflowservice.v1.QueryWorkflowResponse
	(*DescribeWorkflowExecutionResponse)(nil),                    // 154: temporal.api.workflowservice.v1.DescribeWorkflowExecutionResponse
	(*DescribeTaskQueueResponse)(nil),                            // 155: temporal.api.workflowservice.v1.DescribeTaskQueueResponse
	(*GetClusterInfoResponse)(nil),                               // 156: temporal.api.workflowservice.v1.GetClusterInfoResponse
	(*GetSystemInfoResponse)(nil),                                // 157: temporal.api.workflowservice.v1.GetSystemInfoResponse
	(*ListTaskQueuePartitionsResponse)(nil),                      // 158: temporal.api.workflowservice.v1.ListTaskQueuePartitionsResponse
	(*CreateScheduleResponse)(nil),                               // 159: temporal.api.workflowservice.v1.CreateScheduleResponse
	(*DescribeScheduleResponse)(nil),                             // 160: temporal.api.workflowservice.v1.DescribeScheduleResponse
	(*UpdateScheduleResponse)(nil),                               // 161: temporal.api.workflowservice.v1.UpdateScheduleResponse
	(*PatchScheduleResponse)(nil),                                // 162: temporal.api.workflowservice.v1.PatchScheduleResponse
	(*ListScheduleMatchingTimesResponse)(nil),                    // 163: temporal.api.workflowservice.v1.ListScheduleMatchingTimesResponse
	(*DeleteScheduleResponse)(nil),                               // 164: temporal.api.workflowservice.v1.DeleteScheduleResponse
	(*ListSchedulesResponse)(nil),                                // 165: temporal.api.workflowservice.v1.ListSchedulesResponse
	(*CountSchedulesResponse)(nil),                               // 166: temporal.api.workflowservice.v1.CountSchedulesResponse
	(*UpdateWorkerBuildIdCompatibilityResponse)(nil),             // 167: temporal.api.workflowservice.v1.UpdateWorkerBuildIdCompatibilityResponse
	(*GetWorkerBuildIdCompatibilityResponse)(nil),                // 168: temporal.api.workflowservice.v1.GetWorkerBuildIdCompatibilityResponse
	(*UpdateWorkerVersioningRulesResponse)(nil),                  // 169: temporal.api.workflowservice.v1.UpdateWorkerVersioningRulesResponse
	(*GetWorkerVersioningRulesResponse)(nil),                     // 170: temporal.api.workflowservice.v1.GetWorkerVersioningRulesResponse
	(*GetWorkerTaskReachabilityResponse)(nil),                    // 171: temporal.api.workflowservice.v1.GetWorkerTaskReachabilityResponse
	(*DescribeDeploymentResponse)(nil),                           // 172: temporal.api.workflowservice.v1.DescribeDeploymentResponse
	(*DescribeWorkerDeploymentVersionResponse)(nil),              // 173: temporal.api.workflowservice.v1.DescribeWorkerDeploymentVersionResponse
	(*ListDeploymentsResponse)(nil),                              // 174: temporal.api.workflowservice.v1.ListDeploymentsResponse
	(*GetDeploymentReachabilityResponse)(nil),                    // 175: temporal.api.workflowservice.v1.GetDeploymentReachabilityResponse
	(*GetCurrentDeploymentResponse)(nil),                         // 176: temporal.api.workflowservice.v1.GetCurrentDeploymentResponse
	(*SetCurrentDeploymentResponse)(nil),                         // 177: temporal.api.workflowservice.v1.SetCurrentDeploymentResponse
	(*SetWorkerDeploymentCurrentVersionResponse)(nil),            // 178: temporal.api.workflowservice.v1.SetWorkerDeploymentCurrentVersionResponse
	(*DescribeWorkerDeploymentResponse)(nil),                     // 179: temporal.api.workflowservice.v1.DescribeWorkerDeploymentResponse
	(*DeleteWorkerDeploymentResponse)(nil),                       // 180: temporal.api.workflowservice.v1.DeleteWorkerDeploymentResponse
	(*DeleteWorkerDeploymentVersionResponse)(nil),                // 181: temporal.api.workflowservice.v1.DeleteWorkerDeploymentVersionResponse
	(*SetWorkerDeploymentRampingVersionResponse)(nil),            // 182: temporal.api.workflowservice.v1.SetWorkerDeploymentRampingVersionResponse
	(*ListWorkerDeploymentsResponse)(nil),                        // 183: temporal.api.workflowservice.v1.ListWorkerDeploymentsResponse
	(*CreateWorkerDeploymentResponse)(nil),                       // 184: temporal.api.workflowservice.v1.CreateWorkerDeploymentResponse
	(*CreateWorkerDeploymentVersionResponse)(nil),                // 185: temporal.api.workflowservice.v1.CreateWorkerDeploymentVersionResponse
	(*UpdateWorkerDeploymentVersionComputeConfigResponse)(nil),   // 186: temporal.api.workflowservice.v1.UpdateWorkerDeploymentVersionComputeConfigResponse
	(*ValidateWorkerDeploymentVersionComputeConfigResponse)(nil), // 187: temporal.api.workflowservice.v1.ValidateWorkerDeploymentVersionComputeConfigResponse
	(*UpdateWorkerDeploymentVersionMetadataResponse)(nil),        // 188: temporal.api.workflowservice.v1.UpdateWorkerDeploymentVersionMetadataResponse
	(*SetWorkerDeploymentManagerResponse)(nil),                   // 189: temporal.api.workflowservice.v1.SetWorkerDeploymentManagerResponse
	(*UpdateWorkflowExecutionResponse)(nil),                      // 190: temporal.api.workflowservice.v1.UpdateWorkflowExecutionResponse
	(*PollWorkflowExecutionUpdateResponse)(nil),                  // 191: temporal.api.workflowservice.v1.PollWorkflowExecutionUpdateResponse
	(*StartBatchOperationResponse)(nil),                          // 192: temporal.api.workflowservice.v1.StartBatchOperationResponse
	(*StopBatchOperationResponse)(nil),                           // 193: temporal.api.workflowservice.v1.StopBatchOperationResponse
	(*DescribeBatchOperationResponse)(nil),                       // 194: temporal.api.workflowservice.v1.DescribeBatchOperationResponse
	(*ListBatchOperationsResponse)(nil),                          // 195: temporal.api.workflowservice.v1.ListBatchOperationsResponse
	(*PollNexusTaskQueueResponse)(nil),                           // 196: temporal.api.workflowservice.v1.PollNexusTaskQueueResponse
	(*RespondNexusTaskCompletedResponse)(nil),                    // 197: temporal.api.workflowservice.v1.RespondNexusTaskCompletedResponse
	(*RespondNexusTaskFailedResponse)(nil),                       // 198: temporal.api.workflowservice.v1.RespondNexusTaskFailedResponse
	(*UpdateActivityOptionsResponse)(nil),                        // 199: temporal.api.workflowservice.v1.UpdateActivityOptionsResponse
	(*UpdateWorkflowExecutionOptionsResponse)(nil),               // 200: temporal.api.workflowservice.v1.UpdateWorkflowExecutionOptionsResponse
	(*PauseActivityResponse)(nil),                                // 201: temporal.api.workflowservice.v1.PauseActivityResponse
	(*UnpauseActivityResponse)(nil),                              // 202: temporal.api.workflowservice.v1.UnpauseActivityResponse
	(*ResetActivityResponse)(nil),                                // 203: temporal.api.workflowservice.v1.ResetActivityResponse
	(*CreateWorkflowRuleResponse)(nil),                           // 204: temporal.api.workflowservice.v1.CreateWorkflowRuleResponse
	(*DescribeWorkflowRuleResponse)(nil),                         // 205: temporal.api.workflowservice.v1.DescribeWorkflowRuleResponse
	(*DeleteWorkflowRuleResponse)(nil),                           // 206: temporal.api.workflowservice.v1.DeleteWorkflowRuleResponse
	(*ListWorkflowRulesResponse)(nil),                            // 207: temporal.api.workflowservice.v1.ListWorkflowRulesResponse
	(*TriggerWorkflowRuleResponse)(nil),                          // 208: temporal.api.workflowservice.v1.TriggerWorkflowRuleResponse
	(*RecordWorkerHeartbeatResponse)(nil),                        // 209: temporal.api.workflowservice.v1.RecordWorkerHeartbeatResponse
	(*ListWorkersResponse)(nil),                                  // 210: temporal.api.workflowservice.v1.ListWorkersResponse
	(*UpdateTaskQueueConfigResponse)(nil),                        // 211: temporal.api.workflowservice.v1.UpdateTaskQueueConfigResponse
	(*FetchWorkerConfigResponse)(nil),                            // 212: temporal.api.workflowservice.v1.FetchWorkerConfigResponse
	(*UpdateWorkerConfigResponse)(nil),                           // 213: temporal.api.workflowservice.v1.UpdateWorkerConfigResponse
	(*DescribeWorkerResponse)(nil),                               // 214: temporal.api.workflowservice.v1.DescribeWorkerResponse
	(*PauseWorkflowExecutionResponse)(nil),                       // 215: temporal.api.workflowservice.v1.PauseWorkflowExecutionResponse
	(*UnpauseWorkflowExecutionResponse)(nil),                     // 216: temporal.api.workflowservice.v1.UnpauseWorkflowExecutionResponse
	(*StartActivityExecutionResponse)(nil),                       // 217: temporal.api.workflowservice.v1.StartActivityExecutionResponse
	(*DescribeActivityExecutionResponse)(nil),                    // 218: temporal.api.workflowservice.v1.DescribeActivityExecutionResponse
	...
	(*CountActivityExecutionsResponse)(nil),                      // 221: temporal.api.workflowservice.v1.CountActivityExecutionsResponse
	(*RequestCancelActivityExecutionResponse)(nil),               // 222: temporal.api.workflowservice.v1.RequestCancelActivityExecutionResponse
	(*TerminateActivityExecutionResponse)(nil),                   // 223: temporal.api.workflowservice.v1.TerminateActivityExecutionResponse
	(*DeleteActivityExecutionResponse)(nil),                      // 224: temporal.api.workflowservice.v1.DeleteActivityExecutionResponse
	(*StartCallbackExecutionResponse)(nil),                       // 225: temporal.api.workflowservice.v1.StartCallbackExecutionResponse
	(*DescribeCallbackExecutionResponse)(nil),                    // 226: temporal.api.workflowservice.v1.DescribeCallbackExecutionResponse
	(*PollCallbackExecutionResponse)(nil),                        // 227: temporal.api.workflowservice.v1.PollCallbackExecutionResponse
	(*ListCallbackExecutionsResponse)(nil),                       // 228: temporal.api.workflowservice.v1.ListCallbackExecutionsResponse
	(*CountCallbackExecutionsResponse)(nil),                      // 229: temporal.api.workflowservice.v1.CountCallbackExecutionsResponse
	(*TerminateCallbackExecutionResponse)(nil),                   // 230: temporal.api.workflowservice.v1.TerminateCallbackExecutionResponse
...
var file_temporal_api_workflowservice_v1_service_proto_depIdxs = []int32{
	...
	109, // 109: temporal.api.workflowservice.v1.WorkflowService.StartCallbackExecution:input_type -> temporal.api.workflowservice.v1.StartCallbackExecutionRequest
	110, // 110: temporal.api.workflowservice.v1.WorkflowService.DescribeCallbackExecution:input_type -> temporal.api.workflowservice.v1.DescribeCallbackExecutionRequest
	111, // 111: temporal.api.workflowservice.v1.WorkflowService.PollCallbackExecution:input_type -> temporal.api.workflowservice.v1.PollCallbackExecutionRequest
	112, // 112: temporal.api.workflowservice.v1.WorkflowService.ListCallbackExecutions:input_type -> temporal.api.workflowservice.v1.ListCallbackExecutionsRequest
	113, // 113: temporal.api.workflowservice.v1.WorkflowService.CountCallbackExecutions:input_type -> temporal.api.workflowservice.v1.CountCallbackExecutionsRequest
	114, // 114: temporal.api.workflowservice.v1.WorkflowService.TerminateCallbackExecution:input_type -> temporal.api.workflowservice.v1.TerminateCallbackExecutionRequest
	115, // 115: temporal.api.workflowservice.v1.WorkflowService.DeleteCallbackExecution:input_type -> temporal.api.workflowservice.v1.DeleteCallbackExecutionRequest
	116, // 116: temporal.api.workflowservice.v1.WorkflowService.RegisterNamespace:output_type -> temporal.api.workflowservice.v1.RegisterNamespaceResponse
	117, // 117: temporal.api.workflowservice.v1.WorkflowService.DescribeNamespace:output_type -> temporal.api.workflowservice.v1.DescribeNamespaceResponse
	118, // 118: temporal.api.workflowservice.v1.WorkflowService.ListNamespaces:output_type -> temporal.api.workflowservice.v1.ListNamespacesResponse
	119, // 119: temporal.api.workflowservice.v1.WorkflowService.UpdateNamespace:output_type -> temporal.api.workflowservice.v1.UpdateNamespaceResponse
	120, // 120: temporal.api.workflowservice.v1.WorkflowService.DeprecateNamespace:output_type -> temporal.api.workflowservice.v1.DeprecateNamespaceResponse
	121, // 121: temporal.api.workflowservice.v1.WorkflowService.StartWorkflowExecution:output_type -> temporal.api.workflowservice.v1.StartWorkflowExecutionResponse
	122, // 122: temporal.api.workflowservice.v1.WorkflowService.ExecuteMultiOperation:output_type -> temporal.api.workflowservice.v1.ExecuteMultiOperationResponse
	123, // 123: temporal.api.workflowservice.v1.WorkflowService.GetWorkflowExecutionHistory:output_type -> temporal.api.workflowservice.v1.GetWorkflowExecutionHistoryResponse
	124, // 124: temporal.api.workflowservice.v1.WorkflowService.GetWorkflowExecutionHistoryReverse:output_type -> temporal.api.workflowservice.v1.GetWorkflowExecutionHistoryReverseResponse
	125, // 125: temporal.api.workflowservice.v1.WorkflowService.PollWorkflowTaskQueue:output_type -> temporal.api.workflowservice.v1.PollWorkflowTaskQueueResponse
	126, // 126: temporal.api.workflowservice.v1.WorkflowService.RespondWorkflowTaskCompleted:output_type -> temporal.api.workflowservice.v1.RespondWorkflowTaskCompletedResponse
	127, // 127: temporal.api.workflowservice.v1.WorkflowService.RespondWorkflowTaskFailed:output_type -> temporal.api.workflowservice.v1.RespondWorkflowTaskFailedResponse
	128, // 128: temporal.api.workflowservice.v1.WorkflowService.PollActivityTaskQueue:output_type -> temporal.api.workflowservice.v1.PollActivityTaskQueueResponse
	129, // 129: temporal.api.workflowservice.v1.WorkflowService.RecordActivityTaskHeartbeat:output_type -> temporal.api.workflowservice.v1.RecordActivityTaskHeartbeatResponse
	130, // 130: temporal.api.workflowservice.v1.WorkflowService.RecordActivityTaskHeartbeatById:output_type -> temporal.api.workflowservice.v1.RecordActivityTaskHeartbeatByIdResponse
	131, // 131: temporal.api.workflowservice.v1.WorkflowService.RespondActivityTaskCompleted:output_type -> temporal.api.workflowservice.v1.RespondActivityTaskCompletedResponse
	132, // 132: temporal.api.workflowservice.v1.WorkflowService.RespondActivityTaskCompletedById:output_type -> temporal.api.workflowservice.v1.RespondActivityTaskCompletedByIdResponse
	133, // 133: temporal.api.workflowservice.v1.WorkflowService.RespondActivityTaskFailed:output_type -> temporal.api.workflowservice.v1.RespondActivityTaskFailedResponse
	134, // 134: temporal.api.workflowservice.v1.WorkflowService.RespondActivityTaskFailedById:output_type -> temporal.api.workflowservice.v1.RespondActivityTaskFailedByIdResponse
	135, // 135: temporal.api.workflowservice.v1.WorkflowService.RespondActivityTaskCanceled:output_type -> temporal.api.workflowservice.v1.RespondActivityTaskCanceledResponse
	136, // 136: temporal.api.workflowservice.v1.WorkflowService.RespondActivityTaskCanceledById:output_type -> temporal.api.workflowservice.v1.RespondActivityTaskCanceledByIdResponse
	137, // 137: temporal.api.workflowservice.v1.WorkflowService.RequestCancelWorkflowExecution:output_type -> temporal.api.workflowservice.v1.RequestCancelWorkflowExecutionResponse
	138, // 138: temporal.api.workflowservice.v1.WorkflowService.SignalWorkflowExecution:output_type -> temporal.api.workflowservice.v1.SignalWorkflowExecutionResponse
	139, // 139: temporal.api.workflowservice.v1.WorkflowService.SignalWithStartWorkflowExecution:output_type -> temporal.api.workflowservice.v1.SignalWithStartWorkflowExecutionResponse
	140, // 140: temporal.api.workflowservice.v1.WorkflowService.ResetWorkflowExecution:output_type -> temporal.api.workflowservice.v1.ResetWorkflowExecutionResponse
	141, // 141: temporal.api.workflowservice.v1.WorkflowService.TerminateWorkflowExecution:output_type -> temporal.api.workflowservice.v1.TerminateWorkflowExecutionResponse
	142, // 142: temporal.api.workflowservice.v1.WorkflowService.DeleteWorkflowExecution:output_type -> temporal.api.workflowservice.v1.DeleteWorkflowExecutionResponse
	143, // 143: temporal.api.workflowservice.v1.WorkflowService.ListOpenWorkflowExecutions:output_type -> temporal.api.workflowservice.v1.ListOpenWorkflowExecutionsResponse
	144, // 144: temporal.api.workflowservice.v1.WorkflowService.ListClosedWorkflowExecutions:output_type -> temporal.api.workflowservice.v1.ListClosedWorkflowExecutionsResponse
	145, // 145: temporal.api.workflowservice.v1.WorkflowService.ListWorkflowExecutions:output_type -> temporal.api.workflowservice.v1.ListWorkflowExecutionsResponse
	146, // 146: temporal.api.workflowservice.v1.WorkflowService.ListArchivedWorkflowExecutions:output_type -> temporal.api.workflowservice.v1.ListArchivedWorkflowExecutionsResponse
	147, // 147: temporal.api.workflowservice.v1.WorkflowService.ScanWorkflowExecutions:output_type -> temporal.api.workflowservice.v1.ScanWorkflowExecutionsResponse
	148, // 148: temporal.api.workflowservice.v1.WorkflowService.CountWorkflowExecutions:output_type -> temporal.api.workflowservice.v1.CountWorkflowExecutionsResponse
	149, // 149: temporal.api.workflowservice.v1.WorkflowService.GetSearchAttributes:output_type -> temporal.api.workflowservice.v1.GetSearchAttributesResponse
	150, // 150: temporal.api.workflowservice.v1.WorkflowService.RespondQueryTaskCompleted:output_type -> temporal.api.workflowservice.v1.RespondQueryTaskCompletedResponse
	151, // 151: temporal.api.workflowservice.v1.WorkflowService.ResetStickyTaskQueue:output_type -> temporal.api.workflowservice.v1.ResetStickyTaskQueueResponse
	152, // 152: temporal.api.workflowservice.v1.WorkflowService.ShutdownWorker:output_type -> temporal.api.workflowservice.v1.ShutdownWorkerResponse
	153, // 153: temporal.api.workflowservice.v1.WorkflowService.QueryWorkflow:output_type -> temporal.api.workflowservice.v1.QueryWorkflowResponse
	154, // 154: temporal.api.workflowservice.v1.WorkflowService.DescribeWorkflowExecution:output_type -> temporal.api.workflowservice.v1.DescribeWorkflowExecutionResponse
	155, // 155: temporal.api.workflowservice.v1.WorkflowService.DescribeTaskQueue:output_type -> temporal.api.workflowservice.v1.DescribeTaskQueueResponse
	156, // 156: temporal.api.workflowservice.v1.WorkflowService.GetClusterInfo:output_type -> temporal.api.workflowservice.v1.GetClusterInfoResponse
	157, // 157: temporal.api.workflowservice.v1.WorkflowService.GetSystemInfo:output_type -> temporal.api.workflowservice.v1.GetSystemInfoResponse
	158, // 158: temporal.api.workflowservice.v1.WorkflowService.ListTaskQueuePartitions:output_type -> temporal.api.workflowservice.v1.ListTaskQueuePartitionsResponse
	159, // 159: temporal.api.workflowservice.v1.WorkflowService.CreateSchedule:output_type -> temporal.api.workflowservice.v1.CreateScheduleResponse
	160, // 160: temporal.api.workflowservice.v1.WorkflowService.DescribeSchedule:output_type -> temporal.api.workflowservice.v1.DescribeScheduleResponse
	161, // 161: temporal.api.workflowservice.v1.WorkflowService.UpdateSchedule:output_type -> temporal.api.workflowservice.v1.UpdateScheduleResponse
	162, // 162: temporal.api.workflowservice.v1.WorkflowService.PatchSchedule:output_type -> temporal.api.workflowservice.v1.PatchScheduleResponse
	163, // 163: temporal.api.workflowservice.v1.WorkflowService.ListScheduleMatchingTimes:output_type -> temporal.api.workflowservice.v1.ListScheduleMatchingTimesResponse
	164, // 164: temporal.api.workflowservice.v1.WorkflowService.DeleteSchedule:output_type -> temporal.api.workflowservice.v1.DeleteScheduleResponse
	165, // 165: temporal.api.workflowservice.v1.WorkflowService.ListSchedules:output_type -> temporal.api.workflowservice.v1.ListSchedulesResponse
	166, // 166: temporal.api.workflowservice.v1.WorkflowService.CountSchedules:output_type -> temporal.api.workflowservice.v1.CountSchedulesResponse
	167, // 167: temporal.api.workflowservice.v1.WorkflowService.UpdateWorkerBuildIdCompatibility:output_type -> temporal.api.workflowservice.v1.UpdateWorkerBuildIdCompatibilityResponse
	168, // 168: temporal.api.workflowservice.v1.WorkflowService.GetWorkerBuildIdCompatibility:output_type -> temporal.api.workflowservice.v1.GetWorkerBuildIdCompatibilityResponse
	169, // 169: temporal.api.workflowservice.v1.WorkflowService.UpdateWorkerVersioningRules:output_type -> temporal.api.workflowservice.v1.UpdateWorkerVersioningRulesResponse
	170, // 170: temporal.api.workflowservice.v1.WorkflowService.GetWorkerVersioningRules:output_type -> temporal.api.workflowservice.v1.GetWorkerVersioningRulesResponse
	171, // 171: temporal.api.workflowservice.v1.WorkflowService.GetWorkerTaskReachability:output_type -> temporal.api.workflowservice.v1.GetWorkerTaskReachabilityResponse
	172, // 172: temporal.api.workflowservice.v1.WorkflowService.DescribeDeployment:output_type -> temporal.api.workflowservice.v1.DescribeDeploymentResponse
	173, // 173: temporal.api.workflowservice.v1.WorkflowService.DescribeWorkerDeploymentVersion:output_type -> temporal.api.workflowservice.v1.DescribeWorkerDeploymentVersionResponse
	174, // 174: temporal.api.workflowservice.v1.WorkflowService.ListDeployments:output_type -> temporal.api.workflowservice.v1.ListDeploymentsResponse
	175, // 175: temporal.api.workflowservice.v1.WorkflowService.GetDeploymentReachability:output_type -> temporal.api.workflowservice.v1.GetDeploymentReachabilityResponse
	176, // 176: temporal.api.workflowservice.v1.WorkflowService.GetCurrentDeployment:output_type -> temporal.api.workflowservice.v1.GetCurrentDeploymentResponse
	177, // 177: temporal.api.workflowservice.v1.WorkflowService.SetCurrentDeployment:output_type -> temporal.api.workflowservice.v1.SetCurrentDeploymentResponse
	178, // 178: temporal.api.workflowservice.v1.WorkflowService.SetWorkerDeploymentCurrentVersion:output_type -> temporal.api.workflowservice.v1.SetWorkerDeploymentCurrentVersionResponse
	179, // 179: temporal.api.workflowservice.v1.WorkflowService.DescribeWorkerDeployment:output_type -> temporal.api.workflowservice.v1.DescribeWorkerDeploymentResponse
	180, // 180: temporal.api.workflowservice.v1.WorkflowService.DeleteWorkerDeployment:output_type -> temporal.api.workflowservice.v1.DeleteWorkerDeploymentResponse
	181, // 181: temporal.api.workflowservice.v1.WorkflowService.DeleteWorkerDeploymentVersion:output_type -> temporal.api.workflowservice.v1.DeleteWorkerDeploymentVersionResponse
	182, // 182: temporal.api.workflowservice.v1.WorkflowService.SetWorkerDeploymentRampingVersion:output_type -> temporal.api.workflowservice.v1.SetWorkerDeploymentRampingVersionResponse
	183, // 183: temporal.api.workflowservice.v1.WorkflowService.ListWorkerDeployments:output_type -> temporal.api.workflowservice.v1.ListWorkerDeploymentsResponse
	184, // 184: temporal.api.workflowservice.v1.WorkflowService.CreateWorkerDeployment:output_type -> temporal.api.workflowservice.v1.CreateWorkerDeploymentResponse
	185, // 185: temporal.api.workflowservice.v1.WorkflowService.CreateWorkerDeploymentVersion:output_type -> temporal.api.workflowservice.v1.CreateWorkerDeploymentVersionResponse
	186, // 186: temporal.api.workflowservice.v1.WorkflowService.UpdateWorkerDeploymentVersionComputeConfig:output_type -> temporal.api.workflowservice.v1.UpdateWorkerDeploymentVersionComputeConfigResponse
	187, // 187: temporal.api.workflowservice.v1.WorkflowService.ValidateWorkerDeploymentVersionComputeConfig:output_type -> temporal.api.workflowservice.v1.ValidateWorkerDeploymentVersionComputeConfigResponse
	188, // 188: temporal.api.workflowservice.v1.WorkflowService.UpdateWorkerDeploymentVersionMetadata:output_type -> temporal.api.workflowservice.v1.UpdateWorkerDeploymentVersionMetadataResponse
	189, // 189: temporal.api.workflowservice.v1.WorkflowService.SetWorkerDeploymentManager:output_type -> temporal.api.workflowservice.v1.SetWorkerDeploymentManagerResponse
	190, // 190: temporal.api.workflowservice.v1.WorkflowService.UpdateWorkflowExecution:output_type -> temporal.api.workflowservice.v1.UpdateWorkflowExecutionResponse
	191, // 191: temporal.api.workflowservice.v1.WorkflowService.PollWorkflowExecutionUpdate:output_type -> temporal.api.workflowservice.v1.PollWorkflowExecutionUpdateResponse
	192, // 192: temporal.api.workflowservice.v1.WorkflowService.StartBatchOperation:output_type -> temporal.api.workflowservice.v1.StartBatchOperationResponse
	193, // 193: temporal.api.workflowservice.v1.WorkflowService.StopBatchOperation:output_type -> temporal.api.workflowservice.v1.StopBatchOperationResponse
	194, // 194: temporal.api.workflowservice.v1.WorkflowService.DescribeBatchOperation:output_type -> temporal.api.workflowservice.v1.DescribeBatchOperationResponse
	195, // 195: temporal.api.workflowservice.v1.WorkflowService.ListBatchOperations:output_type -> temporal.api.workflowservice.v1.ListBatchOperationsResponse
	196, // 196: temporal.api.workflowservice.v1.WorkflowService.PollNexusTaskQueue:output_type -> temporal.api.workflowservice.v1.PollNexusTaskQueueResponse
	197, // 197: temporal.api.workflowservice.v1.WorkflowService.RespondNexusTaskCompleted:output_type -> temporal.api.workflowservice.v1.RespondNexusTaskCompletedResponse
	198, // 198: temporal.api.workflowservice.v1.WorkflowService.RespondNexusTaskFailed:output_type -> temporal.api.workflowservice.v1.RespondNexusTaskFailedResponse
	199, // 199: temporal.api.workflowservice.v1.WorkflowService.UpdateActivityOptions:output_type -> temporal.api.workflowservice.v1.UpdateActivityOptionsResponse
	200, // 200: temporal.api.workflowservice.v1.WorkflowService.UpdateWorkflowExecutionOptions:output_type -> temporal.api.workflowservice.v1.UpdateWorkflowExecutionOptionsResponse
	201, // 201: temporal.api.workflowservice.v1.WorkflowService.PauseActivity:output_type -> temporal.api.workflowservice.v1.PauseActivityResponse
	202, // 202: temporal.api.workflowservice.v1.WorkflowService.UnpauseActivity:output_type -> temporal.api.workflowservice.v1.UnpauseActivityResponse
	203, // 203: temporal.api.workflowservice.v1.WorkflowService.ResetActivity:output_type -> temporal.api.workflowservice.v1.ResetActivityResponse
	204, // 204: temporal.api.workflowservice.v1.WorkflowService.CreateWorkflowRule:output_type -> temporal.api.workflowservice.v1.CreateWorkflowRuleResponse
	205, // 205: temporal.api.workflowservice.v1.WorkflowService.DescribeWorkflowRule:output_type -> temporal.api.workflowservice.v1.DescribeWorkflowRuleResponse
	206, // 206: temporal.api.workflowservice.v1.WorkflowService.DeleteWorkflowRule:output_type -> temporal.api.workflowservice.v1.DeleteWorkflowRuleResponse
	207, // 207: temporal.api.workflowservice.v1.WorkflowService.ListWorkflowRules:output_type -> temporal.api.workflowservice.v1.ListWorkflowRulesResponse
	208, // 208: temporal.api.workflowservice.v1.WorkflowService.TriggerWorkflowRule:output_type -> temporal.api.workflowservice.v1.TriggerWorkflowRuleResponse
	209, // 209: temporal.api.workflowservice.v1.WorkflowService.RecordWorkerHeartbeat:output_type -> temporal.api.workflowservice.v1.RecordWorkerHeartbeatResponse
	210, // 210: temporal.api.workflowservice.v1.WorkflowService.ListWorkers:output_type -> temporal.api.workflowservice.v1.ListWorkersResponse
	211, // 211: temporal.api.workflowservice.v1.WorkflowService.UpdateTaskQueueConfig:output_type -> temporal.api.workflowservice.v1.UpdateTaskQueueConfigResponse
	212, // 212: temporal.api.workflowservice.v1.WorkflowService.FetchWorkerConfig:output_type -> temporal.api.workflowservice.v1.FetchWorkerConfigResponse
	213, // 213: temporal.api.workflowservice.v1.WorkflowService.UpdateWorkerConfig:output_type -> temporal.api.workflowservice.v1.UpdateWorkerConfigResponse
	214, // 214: temporal.api.workflowservice.v1.WorkflowService.DescribeWorker:output_type -> temporal.api.workflowservice.v1.DescribeWorkerResponse
	215, // 215: temporal.api.workflowservice.v1.WorkflowService.PauseWorkflowExecution:output_type -> temporal.api.workflowservice.v1.PauseWorkflowExecutionResponse
	216, // 216: temporal.api.workflowservice.v1.WorkflowService.UnpauseWorkflowExecution:output_type -> temporal.api.workflowservice.v1.UnpauseWorkflowExecutionResponse
	217, // 217: temporal.api.workflowservice.v1.WorkflowService.StartActivityExecution:output_type -> temporal.api.workflowservice.v1.StartActivityExecutionResponse
	218, // 218: temporal.api.workflowservice.v1.WorkflowService.DescribeActivityExecution:output_type -> temporal.api.workflowservice.v1.DescribeActivityExecutionResponse
	219, // 219: temporal.api.workflowservice.v1.WorkflowService.PollActivityExecution:output_type -> temporal.api.workflowservice.v1.PollActivityExecutionResponse
	220, // 220: temporal.api.workflowservice.v1.WorkflowService.ListActivityExecutions:output_type -> temporal.api.workflowservice.v1.ListActivityExecutionsResponse
	221, // 221: temporal.api.workflowservice.v1.WorkflowService.CountActivityExecutions:output_type -> temporal.api.workflowservice.v1.CountActivityExecutionsResponse
	222, // 222: temporal.api.workflowservice.v1.WorkflowService.RequestCancelActivityExecution:output_type -> temporal.api.workflowservice.v1.RequestCancelActivityExecutionResponse
	223, // 223: temporal.api.workflowservice.v1.WorkflowService.TerminateActivityExecution:output_type -> temporal.api.workflowservice.v1.TerminateActivityExecutionResponse
	224, // 224: temporal.api.workflowservice.v1.WorkflowService.DeleteActivityExecution:output_type -> temporal.api.workflowservice.v1.DeleteActivityExecutionResponse
	225, // 225: temporal.api.workflowservice.v1.WorkflowService.StartCallbackExecution:output_type -> temporal.api.workflowservice.v1.StartCallbackExecutionResponse
	226, // 226: temporal.api.workflowservice.v1.WorkflowService.DescribeCallbackExecution:output_type -> temporal.api.workflowservice.v1.DescribeCallbackExecutionResponse
	227, // 227: temporal.api.workflowservice.v1.WorkflowService.PollCallbackExecution:output_type -> temporal.api.workflowservice.v1.PollCallbackExecutionResponse
	228, // 228: temporal.api.workflowservice.v1.WorkflowService.ListCallbackExecutions:output_type -> temporal.api.workflowservice.v1.ListCallbackExecutionsResponse
	229, // 229: temporal.api.workflowservice.v1.WorkflowService.CountCallbackExecutions:output_type -> temporal.api.workflowservice.v1.CountCallbackExecutionsResponse
	230, // 230: temporal.api.workflowservice.v1.WorkflowService.TerminateCallbackExecution:output_type -> temporal.api.workflowservice.v1.TerminateCallbackExecutionResponse
	231, // 231: temporal.api.workflowservice.v1.WorkflowService.DeleteCallbackExecution:output_type -> temporal.api.workflowservice.v1.DeleteCallbackExecutionResponse
