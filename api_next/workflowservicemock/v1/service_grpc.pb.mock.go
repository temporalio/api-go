...
func (mr *MockWorkflowServiceClientMockRecorder) Echo(ctx, in interface{}, opts ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{ctx, in}, opts...)
...
// Echo mocks base method.
func (m *MockWorkflowServiceServer) Echo(arg0 context.Context, arg1 *workflowservice.EchoRequest) (*workflowservice.EchoResponse, error) {
	m.ctrl.T.Helper()
...
// Echo indicates an expected call of Echo.
func (mr *MockWorkflowServiceServerMockRecorder) Echo(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Echo", reflect.TypeOf((*MockWorkflowServiceServer)(nil).Echo), arg0, arg1)
}
