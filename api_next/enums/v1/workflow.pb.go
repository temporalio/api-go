...
const (
	...
	// (draft: example feature) Placeholder value demonstrating the annotation pattern.
	WORKFLOW_ID_CONFLICT_POLICY_FOO WorkflowIdConflictPolicy = 1000
)
...
var (
	WorkflowIdConflictPolicy_name = map[int32]string{
		...
		1000: "WORKFLOW_ID_CONFLICT_POLICY_FOO",
	}
	WorkflowIdConflictPolicy_value = map[string]int32{
		...
		"WORKFLOW_ID_CONFLICT_POLICY_FOO":                1000,
	}
)
...
// Draft. Defines the versioning behavior to be used by the first task of a new workflow run in a continue-as-new chain.
...
const file_temporal_api_enums_v1_workflow_proto_rawDesc = "" +
	"\n" +
	"$temporal/api/enums/v1/workflow.proto\x12\x15temporal.api.enums.v1\x1a\x18temporal/api/draft.proto*\x8f\x02\n" +
	...
	"-WORKFLOW_ID_REUSE_POLICY_TERMINATE_IF_RUNNING\x10\x04\x1a\x02\b\x01*\x82\x02\n" +
	...
	".WORKFLOW_ID_CONFLICT_POLICY_TERMINATE_EXISTING\x10\x03\x121\n" +
	"\x1fWORKFLOW_ID_CONFLICT_POLICY_FOO\x10\xe8\a\x1a\v\xca\xcc%\aexample*\xa4\x01\n" +
