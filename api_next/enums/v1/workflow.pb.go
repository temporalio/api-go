...
const (
	...
	// (experimental: example feature) Placeholder value demonstrating the annotation pattern.
...
const file_temporal_api_enums_v1_workflow_proto_rawDesc = "" +
	"\n" +
	"$temporal/api/enums/v1/workflow.proto\x12\x15temporal.api.enums.v1\x1a\x1ftemporal/api/experimental.proto*\x8f\x02\n" +
