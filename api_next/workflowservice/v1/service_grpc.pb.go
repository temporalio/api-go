...
type WorkflowServiceClient interface {
	...
	// Echo returns the payload unchanged. Draft: example feature only.
	//
	// (-- api-linter: core::0127::http-annotation=disabled
	//
	//	aip.dev/not-precedent: Echo is a draft RPC not exposed over HTTP. --)
	...
	// Draft. This API might significantly change or be removed in a future release.
	...
	//
	// Draft. This API might significantly change or be removed in a
	// future release.
	...
	// Note: This is a draft API and the behavior may change in a future release.
