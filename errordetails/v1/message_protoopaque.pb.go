...
type NotFoundFailure struct {
	...
	xxx_hidden_CurrentCluster string                 `protobuf:"bytes,1,opt,name=current_cluster,json=currentCluster,proto3"`
	xxx_hidden_ActiveCluster  string                 `protobuf:"bytes,2,opt,name=active_cluster,json=activeCluster,proto3"`
...
func (x *NotFoundFailure) GetCurrentCluster() string {
	if x != nil {
		return x.xxx_hidden_CurrentCluster
	}
	return ""
}
...
func (b0 NotFoundFailure_builder) Build() *NotFoundFailure {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_CurrentCluster = b.CurrentCluster
	x.xxx_hidden_ActiveCluster = b.ActiveCluster
	return m0
}

type WorkflowExecutionAlreadyStartedFailure struct {
	state                     protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_StartRequestId string                 `protobuf:"bytes,1,opt,name=start_request_id,json=startRequestId,proto3"`
...
type NamespaceNotActiveFailure struct {
	...
	xxx_hidden_CurrentCluster string                 `protobuf:"bytes,2,opt,name=current_cluster,json=currentCluster,proto3"`
	xxx_hidden_ActiveCluster  string                 `protobuf:"bytes,3,opt,name=active_cluster,json=activeCluster,proto3"`
	unknownFields             protoimpl.UnknownFields
	sizeCache                 protoimpl.SizeCache
}
...
type NamespaceInvalidStateFailure struct {
	...
	xxx_hidden_AllowedStates []v1.NamespaceState    `protobuf:"varint,3,rep,packed,name=allowed_states,json=allowedStates,proto3,enum=temporal.api.enums.v1.NamespaceState"`
	unknownFields            protoimpl.UnknownFields
	sizeCache                protoimpl.SizeCache
}
...
func (x *NamespaceInvalidStateFailure) GetAllowedStates() []v1.NamespaceState {
	if x != nil {
		return x.xxx_hidden_AllowedStates
	}
	return nil
}
...
func (b0 NamespaceInvalidStateFailure_builder) Build() *NamespaceInvalidStateFailure {
	...
	x.xxx_hidden_AllowedStates = b.AllowedStates
	return m0
}
...
type ClientVersionNotSupportedFailure struct {
	...
	xxx_hidden_SupportedVersions string                 `protobuf:"bytes,3,opt,name=supported_versions,json=supportedVersions,proto3"`
	unknownFields                protoimpl.UnknownFields
	sizeCache                    protoimpl.SizeCache
}
...
func (x *ClientVersionNotSupportedFailure) GetSupportedVersions() string {
	if x != nil {
		return x.xxx_hidden_SupportedVersions
	}
	return ""
}
...
func (x *ClientVersionNotSupportedFailure) SetSupportedVersions(v string) {
	x.xxx_hidden_SupportedVersions = v
}
...
func (b0 ClientVersionNotSupportedFailure_builder) Build() *ClientVersionNotSupportedFailure {
	...
	x.xxx_hidden_SupportedVersions = b.SupportedVersions
	return m0
}
...
type ServerVersionNotSupportedFailure struct {
	...
	xxx_hidden_ClientSupportedServerVersions string                 `protobuf:"bytes,2,opt,name=client_supported_server_versions,json=clientSupportedServerVersions,proto3"`
	unknownFields                            protoimpl.UnknownFields
	sizeCache                                protoimpl.SizeCache
}
...
func (x *ServerVersionNotSupportedFailure) GetClientSupportedServerVersions() string {
	if x != nil {
		return x.xxx_hidden_ClientSupportedServerVersions
	}
	return ""
}
...
func (x *ServerVersionNotSupportedFailure) SetClientSupportedServerVersions(v string) {
	x.xxx_hidden_ClientSupportedServerVersions = v
}
...
func (b0 ServerVersionNotSupportedFailure_builder) Build() *ServerVersionNotSupportedFailure {
	...
	x.xxx_hidden_ClientSupportedServerVersions = b.ClientSupportedServerVersions
	return m0
}
...
type QueryFailedFailure struct {
	state              protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Failure *v11.Failure           `protobuf:"bytes,1,opt,name=failure,proto3"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
type ResourceExhaustedFailure struct {
	state            protoimpl.MessageState    `protogen:"opaque.v1"`
	xxx_hidden_Cause v1.ResourceExhaustedCause `protobuf:"varint,1,opt,name=cause,proto3,enum=temporal.api.enums.v1.ResourceExhaustedCause"`
	xxx_hidden_Scope v1.ResourceExhaustedScope `protobuf:"varint,2,opt,name=scope,proto3,enum=temporal.api.enums.v1.ResourceExhaustedScope"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
type SystemWorkflowFailure struct {
	state                        protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_WorkflowExecution *v12.WorkflowExecution `protobuf:"bytes,1,opt,name=workflow_execution,json=workflowExecution,proto3"`
	xxx_hidden_WorkflowError     string                 `protobuf:"bytes,2,opt,name=workflow_error,json=workflowError,proto3"`
	unknownFields                protoimpl.UnknownFields
	sizeCache                    protoimpl.SizeCache
}
...
func (x *SystemWorkflowFailure) GetWorkflowError() string {
	if x != nil {
		return x.xxx_hidden_WorkflowError
	}
	return ""
}
...
func (b0 SystemWorkflowFailure_builder) Build() *SystemWorkflowFailure {
	...
	x.xxx_hidden_WorkflowError = b.WorkflowError
	return m0
}
...
type NewerBuildExistsFailure struct {
	state                     protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_DefaultBuildId string                 `protobuf:"bytes,1,opt,name=default_build_id,json=defaultBuildId,proto3"`
	unknownFields             protoimpl.UnknownFields
	sizeCache                 protoimpl.SizeCache
}
...
func (x *NewerBuildExistsFailure) GetDefaultBuildId() string {
	if x != nil {
		return x.xxx_hidden_DefaultBuildId
	}
	return ""
}

func (x *NewerBuildExistsFailure) SetDefaultBuildId(v string) {
	x.xxx_hidden_DefaultBuildId = v
}
...
func (b0 NewerBuildExistsFailure_builder) Build() *NewerBuildExistsFailure {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_DefaultBuildId = b.DefaultBuildId
	return m0
}

type MultiOperationExecutionFailure struct {
	state               protoimpl.MessageState                             `protogen:"opaque.v1"`
	xxx_hidden_Statuses *[]*MultiOperationExecutionFailure_OperationStatus `protobuf:"bytes,1,rep,name=statuses,proto3"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
