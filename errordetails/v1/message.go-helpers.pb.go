...
// Marshal an object of type CallbackExecutionAlreadyStartedFailure to the protobuf v3 wire format
func (val *CallbackExecutionAlreadyStartedFailure) Marshal() ([]byte, error) {
	return proto.Marshal(val)
}

// Unmarshal an object of type CallbackExecutionAlreadyStartedFailure from the protobuf v3 wire format
func (val *CallbackExecutionAlreadyStartedFailure) Unmarshal(buf []byte) error {
	return proto.Unmarshal(buf, val)
}

// Size returns the size of the object, in bytes, once serialized
func (val *CallbackExecutionAlreadyStartedFailure) Size() int {
	return proto.Size(val)
}

// Equal returns whether two CallbackExecutionAlreadyStartedFailure values are equivalent by recursively
// comparing the message's fields.
// For more information see the documentation for
// https://pkg.go.dev/google.golang.org/protobuf/proto#Equal
func (this *CallbackExecutionAlreadyStartedFailure) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	var that1 *CallbackExecutionAlreadyStartedFailure
	switch t := that.(type) {
	case *CallbackExecutionAlreadyStartedFailure:
		that1 = t
	case CallbackExecutionAlreadyStartedFailure:
		that1 = &t
	default:
...
// Marshal an object of type NexusOperationNotStartedFailure to the protobuf v3 wire format
func (val *NexusOperationNotStartedFailure) Marshal() ([]byte, error) {
	return proto.Marshal(val)
}

// Unmarshal an object of type NexusOperationNotStartedFailure from the protobuf v3 wire format
func (val *NexusOperationNotStartedFailure) Unmarshal(buf []byte) error {
	return proto.Unmarshal(buf, val)
}

// Size returns the size of the object, in bytes, once serialized
func (val *NexusOperationNotStartedFailure) Size() int {
	return proto.Size(val)
}

// Equal returns whether two NexusOperationNotStartedFailure values are equivalent by recursively
// comparing the message's fields.
// For more information see the documentation for
// https://pkg.go.dev/google.golang.org/protobuf/proto#Equal
func (this *NexusOperationNotStartedFailure) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	var that1 *NexusOperationNotStartedFailure
	switch t := that.(type) {
	case *NexusOperationNotStartedFailure:
		that1 = t
	case NexusOperationNotStartedFailure:
		that1 = &t
	default:
