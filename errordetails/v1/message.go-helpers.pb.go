...
// Marshal an object of type NexusOperationNotStarted to the protobuf v3 wire format
func (val *NexusOperationNotStarted) Marshal() ([]byte, error) {
	return proto.Marshal(val)
}

// Unmarshal an object of type NexusOperationNotStarted from the protobuf v3 wire format
func (val *NexusOperationNotStarted) Unmarshal(buf []byte) error {
	return proto.Unmarshal(buf, val)
}

// Size returns the size of the object, in bytes, once serialized
func (val *NexusOperationNotStarted) Size() int {
	return proto.Size(val)
}

// Equal returns whether two NexusOperationNotStarted values are equivalent by recursively
// comparing the message's fields.
// For more information see the documentation for
// https://pkg.go.dev/google.golang.org/protobuf/proto#Equal
func (this *NexusOperationNotStarted) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	var that1 *NexusOperationNotStarted
	switch t := that.(type) {
	case *NexusOperationNotStarted:
		that1 = t
	case NexusOperationNotStarted:
		that1 = &t
	default:
