...
// existing one.
type NexusOperationAlreadyStartedFailure struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *NexusOperationAlreadyStartedFailure) Reset() {
	*x = NexusOperationAlreadyStartedFailure{}
	if protoimpl.UnsafeEnabled {
...
func (x *NexusOperationAlreadyStartedFailure) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*NexusOperationAlreadyStartedFailure) ProtoMessage() {}

func (x *NexusOperationAlreadyStartedFailure) ProtoReflect() protoreflect.Message {
	mi := &file_temporal_api_errordetails_v1_message_proto_msgTypes[18]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use NexusOperationAlreadyStartedFailure.ProtoReflect.Descriptor instead.
func (*NexusOperationAlreadyStartedFailure) Descriptor() ([]byte, []int) {
	return file_temporal_api_errordetails_v1_message_proto_rawDescGZIP(), []int{18}
}

func (x *NexusOperationAlreadyStartedFailure) GetStartRequestId() string {
	if x != nil {
		return x.StartRequestId
	}
	return ""
...
func (x *NexusOperationAlreadyStartedFailure) GetRunId() string {
	if x != nil {
		return x.RunId
	}
	return ""
...
var file_temporal_api_errordetails_v1_message_proto_rawDesc = []byte{
	...
	0x52, 0x05, 0x72, 0x75, 0x6e, 0x49, 0x64, 0x22, 0x66, 0x0a, 0x23, 0x4e, 0x65, 0x78, 0x75, 0x73,
	0x4f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x41, 0x6c, 0x72, 0x65, 0x61, 0x64, 0x79,
	...
	0xa7, 0x01, 0x0a, 0x1f, 0x69, 0x6f, 0x2e, 0x74, 0x65, 0x6d, 0x70, 0x6f, 0x72, 0x61, 0x6c, 0x2e,
	...
	0x2e, 0x69, 0x6f, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x64, 0x65, 0x74,
	0x61, 0x69, 0x6c, 0x73, 0x2f, 0x76, 0x31, 0x3b, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x64, 0x65, 0x74,
	0x61, 0x69, 0x6c, 0x73, 0xaa, 0x02, 0x1e, 0x54, 0x65, 0x6d, 0x70, 0x6f, 0x72, 0x61, 0x6c, 0x69,
	0x6f, 0x2e, 0x41, 0x70, 0x69, 0x2e, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x44, 0x65, 0x74, 0x61, 0x69,
	0x6c, 0x73, 0x2e, 0x56, 0x31, 0xea, 0x02, 0x21, 0x54, 0x65, 0x6d, 0x70, 0x6f, 0x72, 0x61, 0x6c,
	0x69, 0x6f, 0x3a, 0x3a, 0x41, 0x70, 0x69, 0x3a, 0x3a, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x44, 0x65,
	0x74, 0x61, 0x69, 0x6c, 0x73, 0x3a, 0x3a, 0x56, 0x31, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
...
var file_temporal_api_errordetails_v1_message_proto_goTypes = []interface{}{
	...
	(*NexusOperationAlreadyStartedFailure)(nil),            // 18: temporal.api.errordetails.v1.NexusOperationAlreadyStartedFailure
...
func file_temporal_api_errordetails_v1_message_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_temporal_api_errordetails_v1_message_proto_msgTypes[15].Exporter = func(v interface{}, i int) interface{} {
		...
		file_temporal_api_errordetails_v1_message_proto_msgTypes[16].Exporter = func(v interface{}, i int) interface{} {
		...
		file_temporal_api_errordetails_v1_message_proto_msgTypes[18].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*NexusOperationAlreadyStartedFailure); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_temporal_api_errordetails_v1_message_proto_msgTypes[19].Exporter = func(v interface{}, i int) interface{} {
