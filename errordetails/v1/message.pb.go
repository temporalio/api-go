...
func (x *CallbackExecutionAlreadyStartedFailure) Reset() {
	*x = CallbackExecutionAlreadyStartedFailure{}
	mi := &file_temporal_api_errordetails_v1_message_proto_msgTypes[18]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *CallbackExecutionAlreadyStartedFailure) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CallbackExecutionAlreadyStartedFailure) ProtoMessage() {}

func (x *CallbackExecutionAlreadyStartedFailure) ProtoReflect() protoreflect.Message {
	mi := &file_temporal_api_errordetails_v1_message_proto_msgTypes[18]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CallbackExecutionAlreadyStartedFailure.ProtoReflect.Descriptor instead.
func (*CallbackExecutionAlreadyStartedFailure) Descriptor() ([]byte, []int) {
...
func (x *MultiOperationExecutionFailure_OperationStatus) Reset() {
	*x = MultiOperationExecutionFailure_OperationStatus{}
	mi := &file_temporal_api_errordetails_v1_message_proto_msgTypes[21]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var file_temporal_api_errordetails_v1_message_proto_msgTypes = make([]protoimpl.MessageInfo, 22)
var file_temporal_api_errordetails_v1_message_proto_goTypes = []any{
	...
	(v1.ResourceExhaustedCause)(0),                         // 24: temporal.api.enums.v1.ResourceExhaustedCause
	(v1.ResourceExhaustedScope)(0),                         // 25: temporal.api.enums.v1.ResourceExhaustedScope
...
var file_temporal_api_errordetails_v1_message_proto_depIdxs = []int32{
	22, // 0: temporal.api.errordetails.v1.NamespaceInvalidStateFailure.state:type_name -> temporal.api.enums.v1.NamespaceState
	22, // 1: temporal.api.errordetails.v1.NamespaceInvalidStateFailure.allowed_states:type_name -> temporal.api.enums.v1.NamespaceState
	23, // 2: temporal.api.errordetails.v1.QueryFailedFailure.failure:type_name -> temporal.api.failure.v1.Failure
	24, // 3: temporal.api.errordetails.v1.ResourceExhaustedFailure.cause:type_name -> temporal.api.enums.v1.ResourceExhaustedCause
	25, // 4: temporal.api.errordetails.v1.ResourceExhaustedFailure.scope:type_name -> temporal.api.enums.v1.ResourceExhaustedScope
	26, // 5: temporal.api.errordetails.v1.SystemWorkflowFailure.workflow_execution:type_name -> temporal.api.common.v1.WorkflowExecution
	21, // 6: temporal.api.errordetails.v1.MultiOperationExecutionFailure.statuses:type_name -> temporal.api.errordetails.v1.MultiOperationExecutionFailure.OperationStatus
	27, // 7: temporal.api.errordetails.v1.MultiOperationExecutionFailure.OperationStatus.details:type_name -> google.protobuf.Any
