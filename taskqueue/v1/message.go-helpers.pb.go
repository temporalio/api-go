...
// Marshal an object of type PollerGroupsInfo to the protobuf v3 wire format
func (val *PollerGroupsInfo) Marshal() ([]byte, error) {
	return proto.Marshal(val)
}

// Unmarshal an object of type PollerGroupsInfo from the protobuf v3 wire format
func (val *PollerGroupsInfo) Unmarshal(buf []byte) error {
	return proto.Unmarshal(buf, val)
}

// Size returns the size of the object, in bytes, once serialized
func (val *PollerGroupsInfo) Size() int {
	return proto.Size(val)
}

// Equal returns whether two PollerGroupsInfo values are equivalent by recursively
// comparing the message's fields.
// For more information see the documentation for
// https://pkg.go.dev/google.golang.org/protobuf/proto#Equal
func (this *PollerGroupsInfo) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	var that1 *PollerGroupsInfo
	switch t := that.(type) {
	case *PollerGroupsInfo:
		that1 = t
	case PollerGroupsInfo:
		that1 = &t
	default:
