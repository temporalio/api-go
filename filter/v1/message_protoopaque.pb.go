...
type StartTimeFilter struct {
	state                   protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_EarliestTime *timestamppb.Timestamp `protobuf:"bytes,1,opt,name=earliest_time,json=earliestTime,proto3"`
	xxx_hidden_LatestTime   *timestamppb.Timestamp `protobuf:"bytes,2,opt,name=latest_time,json=latestTime,proto3"`
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
}
