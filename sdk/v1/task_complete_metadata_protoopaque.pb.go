...
type WorkflowTaskCompletedMetadata struct {
	...
	xxx_hidden_CoreUsedFlags []uint32               `protobuf:"varint,1,rep,packed,name=core_used_flags,json=coreUsedFlags,proto3"`
	xxx_hidden_LangUsedFlags []uint32               `protobuf:"varint,2,rep,packed,name=lang_used_flags,json=langUsedFlags,proto3"`
	xxx_hidden_SdkName       string                 `protobuf:"bytes,3,opt,name=sdk_name,json=sdkName,proto3"`
	xxx_hidden_SdkVersion    string                 `protobuf:"bytes,4,opt,name=sdk_version,json=sdkVersion,proto3"`
...
func (x *WorkflowTaskCompletedMetadata) GetCoreUsedFlags() []uint32 {
	if x != nil {
		return x.xxx_hidden_CoreUsedFlags
	}
	return nil
}
...
func (x *WorkflowTaskCompletedMetadata) GetLangUsedFlags() []uint32 {
	if x != nil {
		return x.xxx_hidden_LangUsedFlags
	}
	return nil
}
...
func (b0 WorkflowTaskCompletedMetadata_builder) Build() *WorkflowTaskCompletedMetadata {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_CoreUsedFlags = b.CoreUsedFlags
	x.xxx_hidden_LangUsedFlags = b.LangUsedFlags
