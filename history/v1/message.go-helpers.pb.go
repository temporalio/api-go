...
// Marshal an object of type WorkflowExecutionTimeSkippedEventAttributes to the protobuf v3 wire format
func (val *WorkflowExecutionTimeSkippedEventAttributes) Marshal() ([]byte, error) {
	return proto.Marshal(val)
}

// Unmarshal an object of type WorkflowExecutionTimeSkippedEventAttributes from the protobuf v3 wire format
func (val *WorkflowExecutionTimeSkippedEventAttributes) Unmarshal(buf []byte) error {
	return proto.Unmarshal(buf, val)
}

// Size returns the size of the object, in bytes, once serialized
func (val *WorkflowExecutionTimeSkippedEventAttributes) Size() int {
	return proto.Size(val)
}

// Equal returns whether two WorkflowExecutionTimeSkippedEventAttributes values are equivalent by recursively
// comparing the message's fields.
// For more information see the documentation for
// https://pkg.go.dev/google.golang.org/protobuf/proto#Equal
func (this *WorkflowExecutionTimeSkippedEventAttributes) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	var that1 *WorkflowExecutionTimeSkippedEventAttributes
	switch t := that.(type) {
	case *WorkflowExecutionTimeSkippedEventAttributes:
		that1 = t
	case WorkflowExecutionTimeSkippedEventAttributes:
		that1 = &t
	default:
