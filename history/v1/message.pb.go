...
func (x *WorkflowExecutionTimeSkippedEventAttributes) GetTargetTime() *timestamppb.Timestamp {
	if x != nil {
		return x.TargetTime
	}
	return nil
...
func (x *WorkflowExecutionTimeSkippedEventAttributes) GetDisabledAfterBound() bool {
	if x != nil {
...
func (x *WorkflowExecutionTimeSkippedEventAttributes) GetWallClockTime() *timestamppb.Timestamp {
	if x != nil {
...
const file_temporal_api_history_v1_message_proto_rawDesc = "" +
	...
	"\x06reason\x18\x02 \x01(\tR\x06reason\x12\x1d\n" +
	"\n" +
	"request_id\x18\x03 \x01(\tR\trequestId\"\xe0\x01\n" +
	"+WorkflowExecutionTimeSkippedEventAttributes\x12;\n" +
...
var file_temporal_api_history_v1_message_proto_depIdxs = []int32{
	...
	73,  // 149: temporal.api.history.v1.WorkflowExecutionTimeSkippedEventAttributes.target_time:type_name -> google.protobuf.Timestamp
	73,  // 150: temporal.api.history.v1.WorkflowExecutionTimeSkippedEventAttributes.wall_clock_time:type_name -> google.protobuf.Timestamp
	...
	51,  // 225: temporal.api.history.v1.HistoryEvent.workflow_execution_time_skipped_event_attributes:type_name -> temporal.api.history.v1.WorkflowExecutionTimeSkippedEventAttributes
