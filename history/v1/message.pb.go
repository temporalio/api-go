...
type WorkflowExecutionStartedEventAttributes struct {
	...
	PropagatedNexusSerializationContext *v1.PropagatedNexusSerializationContext `protobuf:"bytes,44,opt,name=propagated_nexus_serialization_context,json=propagatedNexusSerializationContext,proto3" json:"propagated_nexus_serialization_context,omitempty"`
...
func (x *WorkflowExecutionStartedEventAttributes) GetPropagatedNexusSerializationContext() *v1.PropagatedNexusSerializationContext {
	if x != nil {
...
const file_temporal_api_history_v1_message_proto_rawDesc = "" +
	...
	"\x1ftime_skipping_state_propagation\x18+ \x01(\v24.temporal.api.common.v1.TimeSkippingStatePropagationR\x1ctimeSkippingStatePropagation\x12\x90\x01\n" +
	"&propagated_nexus_serialization_context\x18, \x01(\v2;.temporal.api.common.v1.PropagatedNexusSerializationContextR#propagatedNexusSerializationContextJ\x04\b$\x10%J\x04\b*\x10+R parent_pinned_deployment_versionR\x18initial_skipped_duration\"\xab\x01\n" +
...
var file_temporal_api_history_v1_message_proto_goTypes = []any{
	...
	(*v1.PropagatedNexusSerializationContext)(nil),      // 87: temporal.api.common.v1.PropagatedNexusSerializationContext
...
var file_temporal_api_history_v1_message_proto_depIdxs = []int32{
	...
	87,  // 27: temporal.api.history.v1.WorkflowExecutionStartedEventAttributes.propagated_nexus_serialization_context:type_name -> temporal.api.common.v1.PropagatedNexusSerializationContext
