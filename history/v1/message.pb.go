...
type WorkflowExecutionTimeSkippedEventAttributes struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// (-- api-linter: core::0140::prepositions=disabled
	//
	...
	BoundReachedAndTimeSkippingDisabled bool `protobuf:"varint,2,opt,name=bound_reached_and_time_skipping_disabled,json=boundReachedAndTimeSkippingDisabled,proto3" json:"bound_reached_and_time_skipping_disabled,omitempty"`
	unknownFields                       protoimpl.UnknownFields
	sizeCache                           protoimpl.SizeCache
}

func (x *WorkflowExecutionTimeSkippedEventAttributes) Reset() {
	*x = WorkflowExecutionTimeSkippedEventAttributes{}
	mi := &file_temporal_api_history_v1_message_proto_msgTypes[51]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *WorkflowExecutionTimeSkippedEventAttributes) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WorkflowExecutionTimeSkippedEventAttributes) ProtoMessage() {}

func (x *WorkflowExecutionTimeSkippedEventAttributes) ProtoReflect() protoreflect.Message {
	mi := &file_temporal_api_history_v1_message_proto_msgTypes[51]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WorkflowExecutionTimeSkippedEventAttributes.ProtoReflect.Descriptor instead.
func (*WorkflowExecutionTimeSkippedEventAttributes) Descriptor() ([]byte, []int) {
	return file_temporal_api_history_v1_message_proto_rawDescGZIP(), []int{51}
}

func (x *WorkflowExecutionTimeSkippedEventAttributes) GetToTime() *timestamppb.Timestamp {
	if x != nil {
		return x.ToTime
	}
	return nil
...
func (x *WorkflowExecutionTimeSkippedEventAttributes) GetBoundReachedAndTimeSkippingDisabled() bool {
	if x != nil {
		return x.BoundReachedAndTimeSkippingDisabled
	}
	return false
}
...
type HistoryEvent struct {
	...
	//	*HistoryEvent_WorkflowExecutionTimeSkippedEventAttributes
...
func (x *HistoryEvent) GetWorkflowExecutionTimeSkippedEventAttributes() *WorkflowExecutionTimeSkippedEventAttributes {
	if x != nil {
		if x, ok := x.Attributes.(*HistoryEvent_WorkflowExecutionTimeSkippedEventAttributes); ok {
			return x.WorkflowExecutionTimeSkippedEventAttributes
		}
	}
	return nil
}
...
type HistoryEvent_WorkflowExecutionTimeSkippedEventAttributes struct {
	WorkflowExecutionTimeSkippedEventAttributes *WorkflowExecutionTimeSkippedEventAttributes `protobuf:"bytes,65,opt,name=workflow_execution_time_skipped_event_attributes,json=workflowExecutionTimeSkippedEventAttributes,proto3,oneof"`
}
...
func (*HistoryEvent_WorkflowExecutionTimeSkippedEventAttributes) isHistoryEvent_Attributes() {}
...
const file_temporal_api_history_v1_message_proto_rawDesc = "" +
	...
	"\x06reason\x18\x02 \x01(\tR\x06reason\x12\x1d\n" +
	"\n" +
	"request_id\x18\x03 \x01(\tR\trequestId\"\xb9\x01\n" +
	"+WorkflowExecutionTimeSkippedEventAttributes\x123\n" +
	"\ato_time\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\x06toTime\x12U\n" +
	"(bound_reached_and_time_skipping_disabled\x18\x02 \x01(\bR#boundReachedAndTimeSkippingDisabled\"\xec\x05\n" +
	...
	"\x12scheduled_event_id\x18\x04 \x01(\x03R\x10scheduledEventId\"\xafT\n" +
	...
	",workflow_execution_unpaused_event_attributes\x18@ \x01(\v2A.temporal.api.history.v1.WorkflowExecutionUnpausedEventAttributesH\x00R(workflowExecutionUnpausedEventAttributes\x12\xad\x01\n" +
	"0workflow_execution_time_skipped_event_attributes\x18A \x01(\v2D.temporal.api.history.v1.WorkflowExecutionTimeSkippedEventAttributesH\x00R+workflowExecutionTimeSkippedEventAttributesB\f\n" +
	"\n" +
	"attributes\"H\n" +
	"\aHistory\x12=\n" +
...
var file_temporal_api_history_v1_message_proto_goTypes = []any{
	...
	(*WorkflowExecutionTimeSkippedEventAttributes)(nil),                    // 51: temporal.api.history.v1.WorkflowExecutionTimeSkippedEventAttributes
...
var file_temporal_api_history_v1_message_proto_depIdxs = []int32{
	...
	73,  // 149: temporal.api.history.v1.WorkflowExecutionTimeSkippedEventAttributes.to_time:type_name -> google.protobuf.Timestamp
	104, // 150: temporal.api.history.v1.NexusOperationScheduledEventAttributes.input:type_name -> temporal.api.common.v1.Payload
	69,  // 151: temporal.api.history.v1.NexusOperationScheduledEventAttributes.schedule_to_close_timeout:type_name -> google.protobuf.Duration
	64,  // 152: temporal.api.history.v1.NexusOperationScheduledEventAttributes.nexus_header:type_name -> temporal.api.history.v1.NexusOperationScheduledEventAttributes.NexusHeaderEntry
	69,  // 153: temporal.api.history.v1.NexusOperationScheduledEventAttributes.schedule_to_start_timeout:type_name -> google.protobuf.Duration
	69,  // 154: temporal.api.history.v1.NexusOperationScheduledEventAttributes.start_to_close_timeout:type_name -> google.protobuf.Duration
	104, // 155: temporal.api.history.v1.NexusOperationCompletedEventAttributes.result:type_name -> temporal.api.common.v1.Payload
	71,  // 156: temporal.api.history.v1.NexusOperationFailedEventAttributes.failure:type_name -> temporal.api.failure.v1.Failure
	71,  // 157: temporal.api.history.v1.NexusOperationTimedOutEventAttributes.failure:type_name -> temporal.api.failure.v1.Failure
	71,  // 158: temporal.api.history.v1.NexusOperationCanceledEventAttributes.failure:type_name -> temporal.api.failure.v1.Failure
	71,  // 159: temporal.api.history.v1.NexusOperationCancelRequestFailedEventAttributes.failure:type_name -> temporal.api.failure.v1.Failure
	73,  // 160: temporal.api.history.v1.HistoryEvent.event_time:type_name -> google.protobuf.Timestamp
	...
	52,  // 212: temporal.api.history.v1.HistoryEvent.nexus_operation_scheduled_event_attributes:type_name -> temporal.api.history.v1.NexusOperationScheduledEventAttributes
	53,  // 213: temporal.api.history.v1.HistoryEvent.nexus_operation_started_event_attributes:type_name -> temporal.api.history.v1.NexusOperationStartedEventAttributes
	54,  // 214: temporal.api.history.v1.HistoryEvent.nexus_operation_completed_event_attributes:type_name -> temporal.api.history.v1.NexusOperationCompletedEventAttributes
	55,  // 215: temporal.api.history.v1.HistoryEvent.nexus_operation_failed_event_attributes:type_name -> temporal.api.history.v1.NexusOperationFailedEventAttributes
	57,  // 216: temporal.api.history.v1.HistoryEvent.nexus_operation_canceled_event_attributes:type_name -> temporal.api.history.v1.NexusOperationCanceledEventAttributes
	56,  // 217: temporal.api.history.v1.HistoryEvent.nexus_operation_timed_out_event_attributes:type_name -> temporal.api.history.v1.NexusOperationTimedOutEventAttributes
	58,  // 218: temporal.api.history.v1.HistoryEvent.nexus_operation_cancel_requested_event_attributes:type_name -> temporal.api.history.v1.NexusOperationCancelRequestedEventAttributes
	...
	59,  // 220: temporal.api.history.v1.HistoryEvent.nexus_operation_cancel_request_completed_event_attributes:type_name -> temporal.api.history.v1.NexusOperationCancelRequestCompletedEventAttributes
	60,  // 221: temporal.api.history.v1.HistoryEvent.nexus_operation_cancel_request_failed_event_attributes:type_name -> temporal.api.history.v1.NexusOperationCancelRequestFailedEventAttributes
	...
	51,  // 224: temporal.api.history.v1.HistoryEvent.workflow_execution_time_skipped_event_attributes:type_name -> temporal.api.history.v1.WorkflowExecutionTimeSkippedEventAttributes
	61,  // 225: temporal.api.history.v1.History.events:type_name -> temporal.api.history.v1.HistoryEvent
	68,  // 226: temporal.api.history.v1.MarkerRecordedEventAttributes.DetailsEntry.value:type_name -> temporal.api.common.v1.Payloads
...
func file_temporal_api_history_v1_message_proto_init() {
	...
	file_temporal_api_history_v1_message_proto_msgTypes[61].OneofWrappers = []any{
		...
		(*HistoryEvent_WorkflowExecutionTimeSkippedEventAttributes)(nil),
	}
	type x struct{}
