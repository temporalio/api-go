...
const file_temporal_api_nexus_v1_message_proto_rawDesc = "" +
	...
	"\x0foperation_token\x18\x04 \x01(\tR\x0eoperationToken\"\xaa\x04\n" +
	"\aRequest\x12B\n" +
	...
	"\x10cancel_operation\x18\x04 \x01(\v2-.temporal.api.nexus.v1.CancelOperationRequestH\x00R\x0fcancelOperation\x1aL\n" +
	"\fCapabilities\x12<\n" +
	...
	"\x0foperation_error\x18\x03 \x01(\v21.temporal.api.nexus.v1.UnsuccessfulOperationErrorH\x00R\x0eoperationError\x12<\n" +
