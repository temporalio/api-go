...
func (x *CallbackExecutionInfo) GetStatus() v12.CallbackExecutionStatus {
	if x != nil {
		return x.Status
	}
	return v12.CallbackExecutionStatus(0)
}
...
type CallbackExecutionListInfo struct {
	...
	Status v12.CallbackExecutionStatus `protobuf:"varint,3,opt,name=status,proto3,enum=temporal.api.enums.v1.CallbackExecutionStatus" json:"status,omitempty"`
	// The time when the callback was created/scheduled.
...
func (x *CallbackExecutionListInfo) GetStatus() v12.CallbackExecutionStatus {
	if x != nil {
		return x.Status
	}
	return v12.CallbackExecutionStatus(0)
...
type CallbackInfo struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Information on how this callback should be invoked (e.g. its URL and type).
	Callback *v11.Callback `protobuf:"bytes,1,opt,name=callback,proto3" json:"callback,omitempty"`
	...
	// The last attempt's failure, if any.
	LastAttemptFailure *v1.Failure `protobuf:"bytes,6,opt,name=last_attempt_failure,json=lastAttemptFailure,proto3" json:"last_attempt_failure,omitempty"`
	// The time when the next attempt is scheduled.
...
func (x *CallbackInfo) GetCallback() *v11.Callback {
	if x != nil {
		return x.Callback
	}
	return nil
...
func (x *CallbackInfo) GetState() v12.CallbackState {
	if x != nil {
		return x.State
	}
	return v12.CallbackState(0)
...
func (x *CallbackInfo) GetLastAttemptFailure() *v1.Failure {
	if x != nil {
		return x.LastAttemptFailure
	}
	return nil
...
const file_temporal_api_callback_v1_message_proto_rawDesc = "" +
	...
	"\x16state_transition_count\x18\a \x01(\x03R\x14stateTransitionCount\"\x98\x04\n" +
	"\fCallbackInfo\x12<\n" +
...
var file_temporal_api_callback_v1_message_proto_goTypes = []any{
	...
	(*CallbackInfo)(nil),                // 4: temporal.api.callback.v1.CallbackInfo
	(*emptypb.Empty)(nil),               // 5: google.protobuf.Empty
	(*v1.Failure)(nil),                  // 6: temporal.api.failure.v1.Failure
	(*v11.Payload)(nil),                 // 7: temporal.api.common.v1.Payload
	(*v11.Callback)(nil),                // 8: temporal.api.common.v1.Callback
	(v12.CallbackExecutionStatus)(0),    // 9: temporal.api.enums.v1.CallbackExecutionStatus
	(v12.CallbackState)(0),              // 10: temporal.api.enums.v1.CallbackState
...
var file_temporal_api_callback_v1_message_proto_depIdxs = []int32{
	5,  // 0: temporal.api.callback.v1.CallbackExecutionOutcome.success:type_name -> google.protobuf.Empty
	6,  // 1: temporal.api.callback.v1.CallbackExecutionOutcome.failure:type_name -> temporal.api.failure.v1.Failure
	7,  // 2: temporal.api.callback.v1.CallbackExecutionCompletion.success:type_name -> temporal.api.common.v1.Payload
	6,  // 3: temporal.api.callback.v1.CallbackExecutionCompletion.failure:type_name -> temporal.api.failure.v1.Failure
	8,  // 4: temporal.api.callback.v1.CallbackExecutionInfo.callback:type_name -> temporal.api.common.v1.Callback
	...
	11, // 15: temporal.api.callback.v1.CallbackExecutionListInfo.create_time:type_name -> google.protobuf.Timestamp
	11, // 16: temporal.api.callback.v1.CallbackExecutionListInfo.close_time:type_name -> google.protobuf.Timestamp
	12, // 17: temporal.api.callback.v1.CallbackExecutionListInfo.search_attributes:type_name -> temporal.api.common.v1.SearchAttributes
	8,  // 18: temporal.api.callback.v1.CallbackInfo.callback:type_name -> temporal.api.common.v1.Callback
	11, // 19: temporal.api.callback.v1.CallbackInfo.registration_time:type_name -> google.protobuf.Timestamp
	10, // 20: temporal.api.callback.v1.CallbackInfo.state:type_name -> temporal.api.enums.v1.CallbackState
	11, // 21: temporal.api.callback.v1.CallbackInfo.last_attempt_complete_time:type_name -> google.protobuf.Timestamp
	6,  // 22: temporal.api.callback.v1.CallbackInfo.last_attempt_failure:type_name -> temporal.api.failure.v1.Failure
	11, // 23: temporal.api.callback.v1.CallbackInfo.next_attempt_schedule_time:type_name -> google.protobuf.Timestamp
