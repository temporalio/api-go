...
type PendingActivityInfo_PauseInfo struct {
	...
	//	*PendingActivityInfo_PauseInfo_PausePolicy_
...
func (x *PendingActivityInfo_PauseInfo) GetPausePolicy() *PendingActivityInfo_PauseInfo_PausePolicy {
	if x != nil {
		if x, ok := x.PausedBy.(*PendingActivityInfo_PauseInfo_PausePolicy_); ok {
...
type PendingActivityInfo_PauseInfo_PausePolicy_ struct {
	PausePolicy *PendingActivityInfo_PauseInfo_PausePolicy `protobuf:"bytes,5,opt,name=pause_policy,json=pausePolicy,proto3,oneof"`
}
...
func (*PendingActivityInfo_PauseInfo_PausePolicy_) isPendingActivityInfo_PauseInfo_PausedBy() {}
...
type PendingActivityInfo_PauseInfo_PausePolicy struct {
	state                    protoimpl.MessageState `protogen:"open.v1"`
	MaxPauseDurationAttempts int32                  `protobuf:"varint,1,opt,name=max_pause_duration_attempts,json=maxPauseDurationAttempts,proto3" json:"max_pause_duration_attempts,omitempty"`
	unknownFields            protoimpl.UnknownFields
	sizeCache                protoimpl.SizeCache
}

func (x *PendingActivityInfo_PauseInfo_PausePolicy) Reset() {
	*x = PendingActivityInfo_PauseInfo_PausePolicy{}
	mi := &file_temporal_api_workflow_v1_message_proto_msgTypes[26]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PendingActivityInfo_PauseInfo_PausePolicy) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PendingActivityInfo_PauseInfo_PausePolicy) ProtoMessage() {}

func (x *PendingActivityInfo_PauseInfo_PausePolicy) ProtoReflect() protoreflect.Message {
	mi := &file_temporal_api_workflow_v1_message_proto_msgTypes[26]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PendingActivityInfo_PauseInfo_PausePolicy.ProtoReflect.Descriptor instead.
func (*PendingActivityInfo_PauseInfo_PausePolicy) Descriptor() ([]byte, []int) {
	return file_temporal_api_workflow_v1_message_proto_rawDescGZIP(), []int{6, 0, 2}
}

func (x *PendingActivityInfo_PauseInfo_PausePolicy) GetMaxPauseDurationAttempts() int32 {
	if x != nil {
		return x.MaxPauseDurationAttempts
	}
	return 0
}
...
const file_temporal_api_workflow_v1_message_proto_rawDesc = "" +
	...
	"\ruser_metadata\x18\x05 \x01(\v2!.temporal.api.sdk.v1.UserMetadataR\fuserMetadata\"\xf3\x12\n" +
	...
	"\x10activity_options\x18\x18 \x01(\v2).temporal.api.activity.v1.ActivityOptionsR\x0factivityOptions\x1a\xcc\x04\n" +
	"\tPauseInfo\x129\n" +
	"\n" +
	...
	"\x04rule\x18\x04 \x01(\v2<.temporal.api.workflow.v1.PendingActivityInfo.PauseInfo.RuleH\x00R\x04rule\x12h\n" +
	"\fpause_policy\x18\x05 \x01(\v2C.temporal.api.workflow.v1.PendingActivityInfo.PauseInfo.PausePolicyH\x00R\vpausePolicy\x1a<\n" +
	"\x06Manual\x12\x1a\n" +
	...
	"\x06reason\x18\x03 \x01(\tR\x06reason\x1aL\n" +
	"\vPausePolicy\x12=\n" +
	"\x1bmax_pause_duration_attempts\x18\x01 \x01(\x05R\x18maxPauseDurationAttemptsB\v\n" +
	"\tpaused_byB\x13\n" +
...
var file_temporal_api_workflow_v1_message_proto_goTypes = []any{
	...
	(*PendingActivityInfo_PauseInfo_PausePolicy)(nil),     // 27: temporal.api.workflow.v1.PendingActivityInfo.PauseInfo.PausePolicy
...
var file_temporal_api_workflow_v1_message_proto_depIdxs = []int32{
	...
	41,  // 99: temporal.api.workflow.v1.TimeSkippingConfig.max_skipped_duration:type_name -> google.protobuf.Duration
	41,  // 100: temporal.api.workflow.v1.TimeSkippingConfig.max_elapsed_duration:type_name -> google.protobuf.Duration
	31,  // 101: temporal.api.workflow.v1.VersioningOverride.pinned:type_name -> temporal.api.workflow.v1.VersioningOverride.PinnedOverride
	...
	64,  // 104: temporal.api.workflow.v1.RequestIdInfo.event_type:type_name -> temporal.api.enums.v1.EventType
	...
	27,  // 112: temporal.api.workflow.v1.PendingActivityInfo.PauseInfo.pause_policy:type_name -> temporal.api.workflow.v1.PendingActivityInfo.PauseInfo.PausePolicy
...
func file_temporal_api_workflow_v1_message_proto_init() {
	...
	file_temporal_api_workflow_v1_message_proto_msgTypes[23].OneofWrappers = []any{
		...
		(*PendingActivityInfo_PauseInfo_PausePolicy_)(nil),
	}
