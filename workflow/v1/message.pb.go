...
type WorkflowExecutionExtendedInfo struct {
	...
	PropagatedNexusSerializationContext *v1.PropagatedNexusSerializationContext `protobuf:"bytes,9,opt,name=propagated_nexus_serialization_context,json=propagatedNexusSerializationContext,proto3" json:"propagated_nexus_serialization_context,omitempty"`
	unknownFields                       protoimpl.UnknownFields
	sizeCache                           protoimpl.SizeCache
}
...
func (x *WorkflowExecutionExtendedInfo) GetPropagatedNexusSerializationContext() *v1.PropagatedNexusSerializationContext {
	if x != nil {
...
const file_temporal_api_workflow_v1_message_proto_rawDesc = "" +
	...
	"\x16external_payload_count\x18\x1a \x01(\x03R\x14externalPayloadCount\"\xeb\x06\n" +
	...
	"\n" +
	"pause_info\x18\b \x01(\v24.temporal.api.workflow.v1.WorkflowExecutionPauseInfoR\tpauseInfo\x12\x90\x01\n" +
	"&propagated_nexus_serialization_context\x18\t \x01(\v2;.temporal.api.common.v1.PropagatedNexusSerializationContextR#propagatedNexusSerializationContext\x1aj\n" +
...
var file_temporal_api_workflow_v1_message_proto_goTypes = []any{
	...
	(*v1.PropagatedNexusSerializationContext)(nil),        // 42: temporal.api.common.v1.PropagatedNexusSerializationContext
...
var file_temporal_api_workflow_v1_message_proto_depIdxs = []int32{
	...
	42,  // 21: temporal.api.workflow.v1.WorkflowExecutionExtendedInfo.propagated_nexus_serialization_context:type_name -> temporal.api.common.v1.PropagatedNexusSerializationContext
