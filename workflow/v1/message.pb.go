...
type WorkflowExecutionVersioningInfo struct {
	...
	RampPolicy    *v12.RampPolicy `protobuf:"bytes,9,opt,name=ramp_policy,json=rampPolicy,proto3" json:"ramp_policy,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *WorkflowExecutionVersioningInfo) GetRampPolicy() *v12.RampPolicy {
	if x != nil {
		return x.RampPolicy
	}
	return nil
...
const file_temporal_api_workflow_v1_message_proto_rawDesc = "" +
	...
	"\x05value\x18\x02 \x01(\v2'.temporal.api.workflow.v1.RequestIdInfoR\x05value:\x028\x01\"\xd6\x05\n" +
	...
	"\x0frevision_number\x18\b \x01(\x03R\x0erevisionNumber\x12G\n" +
...
var file_temporal_api_workflow_v1_message_proto_goTypes = []any{
	...
	(*v12.RampPolicy)(nil),                           // 44: temporal.api.deployment.v1.RampPolicy
...
var file_temporal_api_workflow_v1_message_proto_depIdxs = []int32{
	...
	44,  // 27: temporal.api.workflow.v1.WorkflowExecutionVersioningInfo.ramp_policy:type_name -> temporal.api.deployment.v1.RampPolicy
