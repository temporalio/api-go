...
// Marshal an object of type UpcomingTimePointInfo to the protobuf v3 wire format
func (val *UpcomingTimePointInfo) Marshal() ([]byte, error) {
	return proto.Marshal(val)
}

// Unmarshal an object of type UpcomingTimePointInfo from the protobuf v3 wire format
func (val *UpcomingTimePointInfo) Unmarshal(buf []byte) error {
	return proto.Unmarshal(buf, val)
}

// Size returns the size of the object, in bytes, once serialized
func (val *UpcomingTimePointInfo) Size() int {
	return proto.Size(val)
}

// Equal returns whether two UpcomingTimePointInfo values are equivalent by recursively
// comparing the message's fields.
// For more information see the documentation for
// https://pkg.go.dev/google.golang.org/protobuf/proto#Equal
func (this *UpcomingTimePointInfo) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	var that1 *UpcomingTimePointInfo
	switch t := that.(type) {
	case *UpcomingTimePointInfo:
		that1 = t
	case UpcomingTimePointInfo:
		that1 = &t
	default:
