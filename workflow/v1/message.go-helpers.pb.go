...
// Marshal an object of type SuggestContinueAsNewSignalInput to the protobuf v3 wire format
func (val *SuggestContinueAsNewSignalInput) Marshal() ([]byte, error) {
	return proto.Marshal(val)
}

// Unmarshal an object of type SuggestContinueAsNewSignalInput from the protobuf v3 wire format
func (val *SuggestContinueAsNewSignalInput) Unmarshal(buf []byte) error {
	return proto.Unmarshal(buf, val)
}

// Size returns the size of the object, in bytes, once serialized
func (val *SuggestContinueAsNewSignalInput) Size() int {
	return proto.Size(val)
}

// Equal returns whether two SuggestContinueAsNewSignalInput values are equivalent by recursively
// comparing the message's fields.
// For more information see the documentation for
// https://pkg.go.dev/google.golang.org/protobuf/proto#Equal
func (this *SuggestContinueAsNewSignalInput) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	var that1 *SuggestContinueAsNewSignalInput
	switch t := that.(type) {
	case *SuggestContinueAsNewSignalInput:
		that1 = t
	case SuggestContinueAsNewSignalInput:
		that1 = &t
	default:
