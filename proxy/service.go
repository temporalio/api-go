...
func (s *workflowServiceProxyServer) WaitForExternalWorkflow(ctx context.Context, in0 *workflowservice.WaitForExternalWorkflowRequest) (*workflowservice.WaitForExternalWorkflowResponse, error) {
	return s.client.WaitForExternalWorkflow(s.reqCtx(ctx), in0)
}
