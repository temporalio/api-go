...
func file_temporal_api_batch_v1_message_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_temporal_api_batch_v1_message_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_temporal_api_batch_v1_message_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BatchOperationTriggerWorkflowRule); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_temporal_api_batch_v1_message_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BatchOperationResetActivities); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_temporal_api_batch_v1_message_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BatchOperationUpdateActivityOptions); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_temporal_api_batch_v1_message_proto_msgTypes[7].OneofWrappers = []interface{}{
		(*BatchOperationUnpauseActivities_Type)(nil),
		(*BatchOperationUnpauseActivities_MatchAll)(nil),
	}
	file_temporal_api_batch_v1_message_proto_msgTypes[8].OneofWrappers = []interface{}{
		(*BatchOperationTriggerWorkflowRule_Id)(nil),
		(*BatchOperationTriggerWorkflowRule_Spec)(nil),
	}
	file_temporal_api_batch_v1_message_proto_msgTypes[9].OneofWrappers = []interface{}{
		(*BatchOperationResetActivities_Type)(nil),
		(*BatchOperationResetActivities_MatchAll)(nil),
	}
	file_temporal_api_batch_v1_message_proto_msgTypes[10].OneofWrappers = []interface{}{
