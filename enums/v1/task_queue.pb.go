...
const (
	...
	ROUTING_CONFIG_UPDATE_STATE_FAILED RoutingConfigUpdateState = 3
)
...
var (
	RoutingConfigUpdateState_name = map[int32]string{
		...
		3: "ROUTING_CONFIG_UPDATE_STATE_FAILED",
	}
...
func (x RoutingConfigUpdateState) String() string {
	...
	case ROUTING_CONFIG_UPDATE_STATE_COMPLETED:
		return "Completed"
	case ROUTING_CONFIG_UPDATE_STATE_FAILED:
		return "Failed"
	default:
		return strconv.Itoa(int(x))
	}
...
const file_temporal_api_enums_v1_task_queue_proto_rawDesc = "" +
	...
	"\x18RATE_LIMIT_SOURCE_SYSTEM\x10\x03*\xc7\x01\n" +
	...
	"%ROUTING_CONFIG_UPDATE_STATE_COMPLETED\x10\x02\x12&\n" +
	"\"ROUTING_CONFIG_UPDATE_STATE_FAILED\x10\x03B\x86\x01\n" +
