...
const (
	...
	EVENT_TYPE_WORKFLOW_EXECUTION_TIME_SKIPPED EventType = 60
)
...
var (
	EventType_name = map[int32]string{
		...
		60: "EVENT_TYPE_WORKFLOW_EXECUTION_TIME_SKIPPED",
	}
...
func (x EventType) String() string {
	...
	case EVENT_TYPE_WORKFLOW_EXECUTION_TIME_SKIPPED:
		return "WorkflowExecutionTimeSkipped"
	default:
...
const file_temporal_api_enums_v1_event_type_proto_rawDesc = "" +
	"\n" +
	"&temporal/api/enums/v1/event_type.proto\x12\x15temporal.api.enums.v1*\x90\x16\n" +
	"\tEventType\x12\x1a\n" +
	...
	"*EVENT_TYPE_WORKFLOW_EXECUTION_TIME_SKIPPED\x10<B\x86\x01\n" +
