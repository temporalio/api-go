...
var WorkerService = struct {
	...
	CancelActivities nexus.OperationReference[*CancelActivitiesRequest, *CancelActivitiesResponse]
}{
	ServiceName:      "temporal.api.worker.v1.WorkerService",
	CancelActivities: nexus.NewOperationReference[*CancelActivitiesRequest, *CancelActivitiesResponse]("cancel-activities"),
}
