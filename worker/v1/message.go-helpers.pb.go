...
// Marshal an object of type FetchWorkerConfigCommandPayload to the protobuf v3 wire format
func (val *FetchWorkerConfigCommandPayload) Marshal() ([]byte, error) {
	return proto.Marshal(val)
}

// Unmarshal an object of type FetchWorkerConfigCommandPayload from the protobuf v3 wire format
func (val *FetchWorkerConfigCommandPayload) Unmarshal(buf []byte) error {
	return proto.Unmarshal(buf, val)
}

// Size returns the size of the object, in bytes, once serialized
func (val *FetchWorkerConfigCommandPayload) Size() int {
	return proto.Size(val)
}

// Equal returns whether two FetchWorkerConfigCommandPayload values are equivalent by recursively
// comparing the message's fields.
// For more information see the documentation for
// https://pkg.go.dev/google.golang.org/protobuf/proto#Equal
func (this *FetchWorkerConfigCommandPayload) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	var that1 *FetchWorkerConfigCommandPayload
	switch t := that.(type) {
	case *FetchWorkerConfigCommandPayload:
		that1 = t
	case FetchWorkerConfigCommandPayload:
		that1 = &t
	default:
...
// Marshal an object of type UpdateWorkerConfigCommandPayload to the protobuf v3 wire format
func (val *UpdateWorkerConfigCommandPayload) Marshal() ([]byte, error) {
	return proto.Marshal(val)
}

// Unmarshal an object of type UpdateWorkerConfigCommandPayload from the protobuf v3 wire format
func (val *UpdateWorkerConfigCommandPayload) Unmarshal(buf []byte) error {
	return proto.Unmarshal(buf, val)
}

// Size returns the size of the object, in bytes, once serialized
func (val *UpdateWorkerConfigCommandPayload) Size() int {
	return proto.Size(val)
}

// Equal returns whether two UpdateWorkerConfigCommandPayload values are equivalent by recursively
// comparing the message's fields.
// For more information see the documentation for
// https://pkg.go.dev/google.golang.org/protobuf/proto#Equal
func (this *UpdateWorkerConfigCommandPayload) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	var that1 *UpdateWorkerConfigCommandPayload
	switch t := that.(type) {
	case *UpdateWorkerConfigCommandPayload:
		that1 = t
	case UpdateWorkerConfigCommandPayload:
		that1 = &t
	default:
