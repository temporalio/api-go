...
// Payload for requesting cancellation of activities via Nexus control queue.
type CancelActivitiesRequestPayload struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Task tokens of the activities to cancel.
...
var file_temporal_api_worker_v1_message_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_temporal_api_worker_v1_message_proto_goTypes = []any{
	...
	(*CancelActivitiesRequestPayload)(nil), // 6: temporal.api.worker.v1.CancelActivitiesRequestPayload
	(*timestamppb.Timestamp)(nil),          // 7: google.protobuf.Timestamp
	(*v1.WorkerDeploymentVersion)(nil),     // 8: temporal.api.deployment.v1.WorkerDeploymentVersion
	(v11.WorkerStatus)(0),                  // 9: temporal.api.enums.v1.WorkerStatus
	(*durationpb.Duration)(nil),            // 10: google.protobuf.Duration
}
var file_temporal_api_worker_v1_message_proto_depIdxs = []int32{
	7,  // 0: temporal.api.worker.v1.WorkerPollerInfo.last_successful_poll_time:type_name -> google.protobuf.Timestamp
	2,  // 1: temporal.api.worker.v1.WorkerHeartbeat.host_info:type_name -> temporal.api.worker.v1.WorkerHostInfo
	8,  // 2: temporal.api.worker.v1.WorkerHeartbeat.deployment_version:type_name -> temporal.api.deployment.v1.WorkerDeploymentVersion
	9,  // 3: temporal.api.worker.v1.WorkerHeartbeat.status:type_name -> temporal.api.enums.v1.WorkerStatus
	7,  // 4: temporal.api.worker.v1.WorkerHeartbeat.start_time:type_name -> google.protobuf.Timestamp
	7,  // 5: temporal.api.worker.v1.WorkerHeartbeat.heartbeat_time:type_name -> google.protobuf.Timestamp
	10, // 6: temporal.api.worker.v1.WorkerHeartbeat.elapsed_since_last_heartbeat:type_name -> google.protobuf.Duration
