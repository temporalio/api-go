...
// Marshal an object of type NexusSDKFailureErrorFailureInfo to the protobuf v3 wire format
func (val *NexusSDKFailureErrorFailureInfo) Marshal() ([]byte, error) {
	return proto.Marshal(val)
}

// Unmarshal an object of type NexusSDKFailureErrorFailureInfo from the protobuf v3 wire format
func (val *NexusSDKFailureErrorFailureInfo) Unmarshal(buf []byte) error {
	return proto.Unmarshal(buf, val)
}

// Size returns the size of the object, in bytes, once serialized
func (val *NexusSDKFailureErrorFailureInfo) Size() int {
	return proto.Size(val)
}

// Equal returns whether two NexusSDKFailureErrorFailureInfo values are equivalent by recursively
// comparing the message's fields.
// For more information see the documentation for
// https://pkg.go.dev/google.golang.org/protobuf/proto#Equal
func (this *NexusSDKFailureErrorFailureInfo) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	var that1 *NexusSDKFailureErrorFailureInfo
	switch t := that.(type) {
	case *NexusSDKFailureErrorFailureInfo:
		that1 = t
	case NexusSDKFailureErrorFailureInfo:
		that1 = &t
	default:
