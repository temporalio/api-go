...
// Marshal an object of type TimeSkippingFastForward to the protobuf v3 wire format
func (val *TimeSkippingFastForward) Marshal() ([]byte, error) {
	return proto.Marshal(val)
}

// Unmarshal an object of type TimeSkippingFastForward from the protobuf v3 wire format
func (val *TimeSkippingFastForward) Unmarshal(buf []byte) error {
	return proto.Unmarshal(buf, val)
}

// Size returns the size of the object, in bytes, once serialized
func (val *TimeSkippingFastForward) Size() int {
	return proto.Size(val)
}

// Equal returns whether two TimeSkippingFastForward values are equivalent by recursively
// comparing the message's fields.
// For more information see the documentation for
// https://pkg.go.dev/google.golang.org/protobuf/proto#Equal
func (this *TimeSkippingFastForward) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	var that1 *TimeSkippingFastForward
	switch t := that.(type) {
	case *TimeSkippingFastForward:
		that1 = t
	case TimeSkippingFastForward:
		that1 = &t
	default:
