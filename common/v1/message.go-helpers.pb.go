...
// Marshal an object of type PausePolicy to the protobuf v3 wire format
func (val *PausePolicy) Marshal() ([]byte, error) {
	return proto.Marshal(val)
}

// Unmarshal an object of type PausePolicy from the protobuf v3 wire format
func (val *PausePolicy) Unmarshal(buf []byte) error {
	return proto.Unmarshal(buf, val)
}

// Size returns the size of the object, in bytes, once serialized
func (val *PausePolicy) Size() int {
	return proto.Size(val)
}

// Equal returns whether two PausePolicy values are equivalent by recursively
// comparing the message's fields.
// For more information see the documentation for
// https://pkg.go.dev/google.golang.org/protobuf/proto#Equal
func (this *PausePolicy) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	var that1 *PausePolicy
	switch t := that.(type) {
	case *PausePolicy:
		that1 = t
	case PausePolicy:
