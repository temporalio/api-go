...
// Marshal an object of type ActivityPausePolicy to the protobuf v3 wire format
func (val *ActivityPausePolicy) Marshal() ([]byte, error) {
	return proto.Marshal(val)
}

// Unmarshal an object of type ActivityPausePolicy from the protobuf v3 wire format
func (val *ActivityPausePolicy) Unmarshal(buf []byte) error {
	return proto.Unmarshal(buf, val)
}

// Size returns the size of the object, in bytes, once serialized
func (val *ActivityPausePolicy) Size() int {
	return proto.Size(val)
}

// Equal returns whether two ActivityPausePolicy values are equivalent by recursively
// comparing the message's fields.
// For more information see the documentation for
// https://pkg.go.dev/google.golang.org/protobuf/proto#Equal
func (this *ActivityPausePolicy) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	var that1 *ActivityPausePolicy
	switch t := that.(type) {
	case *ActivityPausePolicy:
		that1 = t
	case ActivityPausePolicy:
		that1 = &t
	default:
