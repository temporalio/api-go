...
// Marshal an object of type PropagatedNexusSerializationContext to the protobuf v3 wire format
func (val *PropagatedNexusSerializationContext) Marshal() ([]byte, error) {
	return proto.Marshal(val)
}

// Unmarshal an object of type PropagatedNexusSerializationContext from the protobuf v3 wire format
func (val *PropagatedNexusSerializationContext) Unmarshal(buf []byte) error {
	return proto.Unmarshal(buf, val)
}

// Size returns the size of the object, in bytes, once serialized
func (val *PropagatedNexusSerializationContext) Size() int {
	return proto.Size(val)
}

// Equal returns whether two PropagatedNexusSerializationContext values are equivalent by recursively
// comparing the message's fields.
// For more information see the documentation for
// https://pkg.go.dev/google.golang.org/protobuf/proto#Equal
func (this *PropagatedNexusSerializationContext) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	var that1 *PropagatedNexusSerializationContext
	switch t := that.(type) {
	case *PropagatedNexusSerializationContext:
		that1 = t
	case PropagatedNexusSerializationContext:
		that1 = &t
	default:
