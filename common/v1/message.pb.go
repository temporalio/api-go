...
type TimeSkippingInfo struct {
	...
	FastForward *TimeSkippingInfo_TimeSkippingFastForwardInfo `protobuf:"bytes,2,opt,name=fast_forward,json=fastForward,proto3" json:"fast_forward,omitempty"`
...
func (x *TimeSkippingInfo) GetFastForward() *TimeSkippingInfo_TimeSkippingFastForwardInfo {
	if x != nil {
		return x.FastForward
	}
	return nil
...
type TimeSkippingInfo_TimeSkippingFastForwardInfo struct {
	state protoimpl.MessageState `protogen:"open.v1"`
...
func (x *TimeSkippingInfo_TimeSkippingFastForwardInfo) Reset() {
	*x = TimeSkippingInfo_TimeSkippingFastForwardInfo{}
	mi := &file_temporal_api_common_v1_message_proto_msgTypes[38]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *TimeSkippingInfo_TimeSkippingFastForwardInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TimeSkippingInfo_TimeSkippingFastForwardInfo) ProtoMessage() {}

func (x *TimeSkippingInfo_TimeSkippingFastForwardInfo) ProtoReflect() protoreflect.Message {
	mi := &file_temporal_api_common_v1_message_proto_msgTypes[38]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TimeSkippingInfo_TimeSkippingFastForwardInfo.ProtoReflect.Descriptor instead.
func (*TimeSkippingInfo_TimeSkippingFastForwardInfo) Descriptor() ([]byte, []int) {
	return file_temporal_api_common_v1_message_proto_rawDescGZIP(), []int{22, 0}
}

func (x *TimeSkippingInfo_TimeSkippingFastForwardInfo) GetCreateTime() *timestamppb.Timestamp {
	if x != nil {
		return x.CreateTime
	}
	return nil
...
func (x *TimeSkippingInfo_TimeSkippingFastForwardInfo) GetTargetTime() *timestamppb.Timestamp {
	if x != nil {
		return x.TargetTime
	}
	return nil
...
func (x *TimeSkippingInfo_TimeSkippingFastForwardInfo) GetHasCompleted() bool {
	if x != nil {
...
const file_temporal_api_common_v1_message_proto_rawDesc = "" +
	...
	"\x18fast_forward_target_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\x15fastForwardTargetTime\"\x98\x03\n" +
	"\x10TimeSkippingInfo\x12=\n" +
	"\fcurrent_time\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\vcurrentTime\x12g\n" +
	"\ffast_forward\x18\x02 \x01(\v2D.temporal.api.common.v1.TimeSkippingInfo.TimeSkippingFastForwardInfoR\vfastForward\x12\x1d\n" +
	"\n" +
	"is_running\x18\x03 \x01(\bR\tisRunning\x1a\xbc\x01\n" +
...
var file_temporal_api_common_v1_message_proto_goTypes = []any{
	...
	(*TimeSkippingInfo)(nil),               // 22: temporal.api.common.v1.TimeSkippingInfo
	...
	(*TimeSkippingInfo_TimeSkippingFastForwardInfo)(nil), // 38: temporal.api.common.v1.TimeSkippingInfo.TimeSkippingFastForwardInfo
...
var file_temporal_api_common_v1_message_proto_depIdxs = []int32{
	...
	40, // 21: temporal.api.common.v1.TimeSkippingConfig.fast_forward:type_name -> google.protobuf.Duration
	40, // 22: temporal.api.common.v1.TimeSkippingStatePropagation.initial_skipped_duration:type_name -> google.protobuf.Duration
	44, // 23: temporal.api.common.v1.TimeSkippingStatePropagation.fast_forward_target_time:type_name -> google.protobuf.Timestamp
	44, // 24: temporal.api.common.v1.TimeSkippingInfo.current_time:type_name -> google.protobuf.Timestamp
	38, // 25: temporal.api.common.v1.TimeSkippingInfo.fast_forward:type_name -> temporal.api.common.v1.TimeSkippingInfo.TimeSkippingFastForwardInfo
	...
	36, // 30: temporal.api.common.v1.Link.WorkflowEvent.event_ref:type_name -> temporal.api.common.v1.Link.WorkflowEvent.EventReference
	37, // 31: temporal.api.common.v1.Link.WorkflowEvent.request_id_ref:type_name -> temporal.api.common.v1.Link.WorkflowEvent.RequestIdReference
	...
	44, // 34: temporal.api.common.v1.TimeSkippingInfo.TimeSkippingFastForwardInfo.create_time:type_name -> google.protobuf.Timestamp
	44, // 35: temporal.api.common.v1.TimeSkippingInfo.TimeSkippingFastForwardInfo.target_time:type_name -> google.protobuf.Timestamp
