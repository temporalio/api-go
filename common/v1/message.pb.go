...
const file_temporal_api_common_v1_message_proto_rawDesc = "" +
	...
	"\avariantJ\x04\b\x01\x10\x02\"\xab\a\n" +
	"\x04Link\x12S\n" +
	"\x0eworkflow_event\x18\x01 \x01(\v2*.temporal.api.common.v1.Link.WorkflowEventH\x00R\rworkflowEvent\x12D\n" +
	"\tbatch_job\x18\x02 \x01(\v2%.temporal.api.common.v1.Link.BatchJobH\x00R\bbatchJob\x12V\n" +
	"\x0fnexus_operation\x18\x03 \x01(\v2+.temporal.api.common.v1.Link.NexusOperationH\x00R\x0enexusOperation\x1a\x97\x04\n" +
	...
	"\treference\x1a!\n" +
	"\bBatchJob\x12\x15\n" +
	"\x06job_id\x18\x01 \x01(\tR\x05jobId\x1ah\n" +
