...
type TimeSkippingFastForward struct {
	state protoimpl.MessageState `protogen:"open.v1"`
...
func (x *TimeSkippingFastForward) Reset() {
	*x = TimeSkippingFastForward{}
	mi := &file_temporal_api_common_v1_message_proto_msgTypes[22]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *TimeSkippingFastForward) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TimeSkippingFastForward) ProtoMessage() {}

func (x *TimeSkippingFastForward) ProtoReflect() protoreflect.Message {
	mi := &file_temporal_api_common_v1_message_proto_msgTypes[22]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TimeSkippingFastForward.ProtoReflect.Descriptor instead.
func (*TimeSkippingFastForward) Descriptor() ([]byte, []int) {
	return file_temporal_api_common_v1_message_proto_rawDescGZIP(), []int{22}
}

func (x *TimeSkippingFastForward) GetCreateTime() *timestamppb.Timestamp {
	if x != nil {
		return x.CreateTime
	}
	return nil
...
func (x *TimeSkippingFastForward) GetTargetTime() *timestamppb.Timestamp {
	if x != nil {
		return x.TargetTime
	}
	return nil
...
func (x *TimeSkippingFastForward) GetHasCompleted() bool {
	if x != nil {
...
const file_temporal_api_common_v1_message_proto_rawDesc = "" +
	...
	"\x18fast_forward_target_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\x15fastForwardTargetTime\"\xb8\x01\n" +
	"\x17TimeSkippingFastForward\x12;\n" +
...
var file_temporal_api_common_v1_message_proto_goTypes = []any{
	...
	(*TimeSkippingFastForward)(nil),        // 22: temporal.api.common.v1.TimeSkippingFastForward
...
var file_temporal_api_common_v1_message_proto_depIdxs = []int32{
	...
	43, // 24: temporal.api.common.v1.TimeSkippingFastForward.create_time:type_name -> google.protobuf.Timestamp
	43, // 25: temporal.api.common.v1.TimeSkippingFastForward.target_time:type_name -> google.protobuf.Timestamp
