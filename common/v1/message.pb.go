...
type ActivityPausePolicy struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Maximum number of attempts before an activity will be paused by the server. If 0, the activity
...
func (x *ActivityPausePolicy) Reset() {
	*x = ActivityPausePolicy{}
	mi := &file_temporal_api_common_v1_message_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ActivityPausePolicy) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ActivityPausePolicy) ProtoMessage() {}

func (x *ActivityPausePolicy) ProtoReflect() protoreflect.Message {
	mi := &file_temporal_api_common_v1_message_proto_msgTypes[10]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ActivityPausePolicy.ProtoReflect.Descriptor instead.
func (*ActivityPausePolicy) Descriptor() ([]byte, []int) {
	return file_temporal_api_common_v1_message_proto_rawDescGZIP(), []int{10}
}

func (x *ActivityPausePolicy) GetMaximumAttempts() int32 {
	if x != nil {
		return x.MaximumAttempts
	}
	return 0
...
const file_temporal_api_common_v1_message_proto_rawDesc = "" +
	...
	"\x19non_retryable_error_types\x18\x05 \x03(\tR\x16nonRetryableErrorTypes\"@\n" +
	"\x13ActivityPausePolicy\x12)\n" +
	"\x10maximum_attempts\x18\x01 \x01(\x05R\x0fmaximumAttempts\"n\n" +
...
var file_temporal_api_common_v1_message_proto_goTypes = []any{
	...
	(*ActivityPausePolicy)(nil),            // 10: temporal.api.common.v1.ActivityPausePolicy
